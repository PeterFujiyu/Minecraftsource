...
public class GlStateManager {
    ...
    private static final FramebufferState READ_FRAMEBUFFER = new FramebufferState();
    private static final FramebufferState DRAW_FRAMEBUFFER = new FramebufferState();
    ...
    public static void _glBindFramebuffer(int target, int framebuffer) {
        ...
        switch (target) {
            case 36008: {
                boolean bl2 = READ_FRAMEBUFFER.setBoundFramebuffer(framebuffer);
                break;
            }
            case 36009: {
                boolean bl2 = DRAW_FRAMEBUFFER.setBoundFramebuffer(framebuffer);
                break;
            }
            case 36160: {
                boolean bl2 = READ_FRAMEBUFFER.setBoundFramebuffer(framebuffer) | DRAW_FRAMEBUFFER.setBoundFramebuffer(framebuffer);
                break;
            }
            default: {
                boolean bl2 = bl = true;
    ...
    public static void _genTextures(int[] textures) {
        RenderSystem.assertOnRenderThreadOrInit();
        PLOT_TEXTURES.setValue(numTextures += textures.length);
