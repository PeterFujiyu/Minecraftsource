...
public interface RecipeDisplay {
    ...
    public static final PacketCodec<RegistryByteBuf, RecipeDisplay> STREAM_CODEC = PacketCodecs.registryValue(RegistryKeys.RECIPE_DISPLAY).dispatch(RecipeDisplay::serializer, Serializer::streamCodec);
