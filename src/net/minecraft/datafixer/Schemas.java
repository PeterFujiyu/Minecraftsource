...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(new RenameEntityNbtKeyFix(schema164, "EntityPaintingFieldsRenameFix", "minecraft:painting", Map.of("Motive", "variant", "Facing", "facing")));
        ...
        builder.addFixer(ItemNameFix.create(schema184, "Pottery shard item renaming to Pottery sherd", Schemas.replacing(Stream.of("minecraft:angler_pottery_shard", "minecraft:archer_pottery_shard", "minecraft:arms_up_pottery_shard", "minecraft:blade_pottery_shard", "minecraft:brewer_pottery_shard", "minecraft:burn_pottery_shard", "minecraft:danger_pottery_shard", "minecraft:explorer_pottery_shard", "minecraft:friend_pottery_shard", "minecraft:heart_pottery_shard", "minecraft:heartbreak_pottery_shard", "minecraft:howl_pottery_shard", "minecraft:miner_pottery_shard", "minecraft:mourner_pottery_shard", "minecraft:plenty_pottery_shard", "minecraft:prize_pottery_shard", "minecraft:sheaf_pottery_shard", "minecraft:shelter_pottery_shard", "minecraft:skull_pottery_shard", "minecraft:snort_pottery_shard").collect(Collectors.toMap(Function.identity(), string -> string.replace("_pottery_shard", "_pottery_sherd"))))));
        ...
        builder.addFixer(new RenameChunkStatusFix(schema186, "Remove liquid_carvers and heightmap chunk statuses", Schemas.replacing(Map.of("minecraft:liquid_carvers", "minecraft:carvers", "minecraft:heightmaps", "minecraft:spawn"))));
        ...
        builder.addFixer(new RenameEntityAttributesFix(schema209, "Rename jump strength attribute", Schemas.replacing("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
        ...
        builder.addFixer(new EntityAttributeBaseFix(schema243, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema243, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema243, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", followRange -> followRange == 48.0 ? 16.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema243, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", followRange -> followRange == 40.0 ? 16.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema243, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", followRange -> followRange == 16.0 ? 12.0 : followRange));
        builder.addFixer(new EntityAttributeBaseFix(schema243, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", followRange -> followRange == 16.0 ? 24.0 : followRange));
    }
