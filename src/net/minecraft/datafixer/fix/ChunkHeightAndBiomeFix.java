...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(NAME, type, type2, (Typed<?> chunk) -> chunk.updateTyped(opticFinder, type3, level -> {
            ...
            MutableObject<Supplier<ProtoChunkTickListFix.PalettedSection>> mutableObject = new MutableObject<Supplier<ProtoChunkTickListFix.PalettedSection>>(() -> null);
    ...
    private static Dynamic<?> fixLevel(Dynamic<?> level, boolean overworld, boolean heightAlreadyUpdated, boolean atNoiseStatus, Supplier<ProtoChunkTickListFix.PalettedSection> supplier) {
        ...
        if (optional.isPresent() && !"empty".equals(string = (dynamic2 = optional.get()).asString(""))) {
            ...
            ProtoChunkTickListFix.PalettedSection lv = supplier.get();
            if (lv != null) {
