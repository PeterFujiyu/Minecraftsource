...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(TypeReferences.ITEM_STACK), this.getOutputSchema().getType(TypeReferences.ITEM_STACK), (Typed<?> itemStackTyped) -> itemStackTyped.update(opticFinder, type2, id -> id.map(ordinal -> Pair.of(TypeReferences.ITEM_NAME.typeName(), ItemIdFix.fromId(ordinal)), named -> named)));
    }
}
