...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        list.add(this.fixTypeEverywhereTyped("BlockPos format for compass target", type, ItemNbtFix.fixNbt(type, "minecraft:compass"::equals, tagDynamic -> tagDynamic.update("LodestonePos", FixUtil::fixBlockPos))));
