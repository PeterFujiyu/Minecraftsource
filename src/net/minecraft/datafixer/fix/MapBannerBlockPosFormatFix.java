...
extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        return this.fixTypeEverywhereTyped("MapBannerBlockPosFormatFix", this.getInputSchema().getType(TypeReferences.SAVED_DATA_MAP_DATA), mapDatTyped -> mapDatTyped.update(DSL.remainderFinder(), mapDatDynamic -> mapDatDynamic.update("data", MapBannerBlockPosFormatFix::update)));
    }
}
