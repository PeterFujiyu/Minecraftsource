...
extends MinecraftServer {
    ...
    public static TestServer create(Thread thread, LevelStorage.Session session, ResourcePackManager resourcePackManager, Collection<TestFunction> batches, BlockPos pos) {
        ...
        DataConfiguration lv = new DataConfiguration(new DataPackSettings(new ArrayList<String>(resourcePackManager.getIds()), List.of()), ENABLED_FEATURES);
    ...
    public void tick(BooleanSupplier shouldKeepTicking) {
        ...
        if (this.testSet.isDone()) {
            ...
            if (this.testSet.hasFailedOptionalTests()) {
                ...
                this.testSet.getOptionalTests().forEach(test -> LOGGER.info("   - {} with rotation: {}", (Object)test.getTemplatePath(), (Object)test.getRotation()));
            }
            LOGGER.info("====================================================");
        }
    }
