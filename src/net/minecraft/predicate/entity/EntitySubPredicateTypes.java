...
public class EntitySubPredicateTypes {
    ...
    public static final VariantType<SalmonEntity.Variant> SALMON = EntitySubPredicateTypes.register("salmon", VariantType.create(SalmonEntity.Variant.CODEC, entity -> {
        Optional<Object> optional;
        if (entity instanceof SalmonEntity) {
            SalmonEntity lv = (SalmonEntity)entity;
            optional = Optional.of(lv.getVariant());
        } else {
            optional = Optional.empty();
        }
