...
implements Fertilizable {
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ...
        block0: for (int i = 0; i < 128; ++i) {
            ...
            if (lv4.isOf(lv2.getBlock()) && random.nextInt(10) == 0 && (lv5 = (Fertilizable)((Object)lv2.getBlock())).isFertilizable(world, lv3, lv4)) {
            ...
            if (random.nextInt(8) == 0) {
                ...
                lv6 = ((RandomPatchFeatureConfig)list.get(0).config()).feature();
            } else {
                if (!optional.isPresent()) continue;
                lv6 = (RegistryEntry<PlacedFeature>)optional.get();
            }
            ((PlacedFeature)lv6.value()).generateUnregistered(world, world.getChunkManager().getChunkGenerator(), random, lv3);
        }
    }
