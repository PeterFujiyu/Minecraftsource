...
implements ShapeContext {
    ...
    protected EntityShapeContext(Entity entity, boolean collidesWithFluid) {
        this(entity.isDescending(), entity.getY(), entity instanceof LivingEntity ? ((LivingEntity)entity).getMainHandStack() : ItemStack.EMPTY, collidesWithFluid ? state -> true : (entity instanceof LivingEntity ? ((LivingEntity)entity)::canWalkOnFluid : state -> false), entity);
    }
