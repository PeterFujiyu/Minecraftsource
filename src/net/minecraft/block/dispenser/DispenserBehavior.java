    ...
    public static void registerDefaults() {
        ...
        DispenserBlock.registerBehavior(Items.ARMOR_STAND, new ItemDispenserBehavior(){
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                ArmorStandEntity lv4 = EntityType.ARMOR_STAND.spawn(lv3, consumer = EntityType.copier(armorStand -> armorStand.setYaw(lv.getPositiveHorizontalDegrees()), lv3, stack, null), lv2, SpawnReason.DISPENSER, false, false);
                if (lv4 != null) {
                    stack.decrement(1);
                }
                return stack;
        ...
        DispenserBlock.registerBehavior(Items.SADDLE, new FallibleItemDispenserBehavior(){
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                if (!list.isEmpty()) {
                    ((Saddleable)((Object)list.get(0))).saddle(stack.split(1), SoundCategory.BLOCKS);
        ...
        DispenserBlock.registerBehavior(Items.CHEST, new FallibleItemDispenserBehavior(){
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                BlockPos lv = pointer.pos().offset(pointer.state().get(DispenserBlock.FACING));
                List<AbstractDonkeyEntity> list = pointer.world().getEntitiesByClass(AbstractDonkeyEntity.class, new Box(lv), entity -> entity.isAlive() && !entity.hasChest());
        ...
        ItemDispenserBehavior lv3 = new ItemDispenserBehavior(){
        ...
        DispenserBlock.registerBehavior(Items.LAVA_BUCKET, lv3);
        DispenserBlock.registerBehavior(Items.WATER_BUCKET, lv3);
        DispenserBlock.registerBehavior(Items.POWDER_SNOW_BUCKET, lv3);
        DispenserBlock.registerBehavior(Items.SALMON_BUCKET, lv3);
        DispenserBlock.registerBehavior(Items.COD_BUCKET, lv3);
        DispenserBlock.registerBehavior(Items.PUFFERFISH_BUCKET, lv3);
        ...
        for (DyeColor lv4 : DyeColor.values()) {
            DispenserBlock.registerBehavior(ShulkerBoxBlock.get(lv4).asItem(), new BlockPlacementDispenserBehavior());
        }
