...
extends WallMountedBlock {
    ...
    private void updateNeighbors(BlockState arg, World arg2, BlockPos pos) {
        Direction lv;
        WireOrientation lv2 = OrientationHelper.getEmissionOrientation(arg2, lv, (lv = ButtonBlock.getDirection(arg).getOpposite()).getAxis().isHorizontal() ? Direction.UP : (Direction)arg.get(FACING));
        arg2.updateNeighborsAlways(pos, this, lv2);
        arg2.updateNeighborsAlways(pos.offset(lv), this, lv2);
    }
