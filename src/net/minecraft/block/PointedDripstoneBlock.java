...
Waterloggable {
    ...
    protected void onProjectileHit(World world, BlockState state, BlockHitResult hit, ProjectileEntity projectile) {
        ...
        if (world instanceof ServerWorld && projectile.canModifyAt(lv2 = (ServerWorld)world, lv) && projectile.canBreakBlocks(lv2) && projectile instanceof TridentEntity && projectile.getVelocity().length() > 0.6) {
    ...
    protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        Vec3d lv3 = state.getModelOffset(pos);
