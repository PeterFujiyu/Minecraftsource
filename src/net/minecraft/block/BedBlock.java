...
implements BlockEntityProvider {
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        BlockState lv3;
        BedPart lv;
        if (!world.isClient && player.isCreative() && (lv = state.get(PART)) == BedPart.FOOT && (lv3 = world.getBlockState(lv2 = pos.offset(BedBlock.getDirectionTowardsOtherPart(lv, (Direction)state.get(FACING))))).isOf(this) && lv3.get(PART) == BedPart.HEAD) {
