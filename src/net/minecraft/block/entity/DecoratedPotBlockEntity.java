...
SingleStackInventory.SingleStackBlockEntityInventory {
    ...
    protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        ...
        if (!this.readLootTable(nbt)) {
            this.stack = nbt.contains(ITEM_NBT_KEY, NbtElement.COMPOUND_TYPE) ? ItemStack.fromNbt(registries, nbt.getCompound(ITEM_NBT_KEY)).orElse(ItemStack.EMPTY) : ItemStack.EMPTY;
        }
    }
