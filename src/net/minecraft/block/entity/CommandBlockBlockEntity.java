...
extends BlockEntity {
    ...
    private final CommandBlockExecutor commandExecutor = new CommandBlockExecutor(){
        ...
        public ServerCommandSource getSource() {
            ...
            return new ServerCommandSource(this, Vec3d.ofCenter(CommandBlockBlockEntity.this.pos), new Vec2f(0.0f, lv.getPositiveHorizontalDegrees()), this.getWorld(), 2, this.getName().getString(), this.getName(), this.getWorld().getServer(), null);
        }
