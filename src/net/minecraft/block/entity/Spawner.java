...
public interface Spawner {
    ...
    public static Text getSpawnedEntityText(ItemStack stack, String spawnDataKey) {
        ...
        if (lv2 != null) {
            return Registries.ENTITY_TYPE.getOptionalValue(lv2).map(entityType -> Text.translatable(entityType.getTranslationKey()).formatted(Formatting.GRAY)).orElse(null);
        }
        return null;
    }
