...
extends BlockEntity {
    ...
    protected void writeNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        ...
        if (this.customName != null) {
            nbt.putString(CUSTOM_NAME_NBT_KEY, Text.Serialization.toJsonString(this.customName, registries));
        }
    }
    ...
    protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        ...
        this.customName = nbt.contains(CUSTOM_NAME_NBT_KEY, NbtElement.STRING_TYPE) ? SkullBlockEntity.tryParseCustomName(nbt.getString(CUSTOM_NAME_NBT_KEY), registries) : null;
    }
