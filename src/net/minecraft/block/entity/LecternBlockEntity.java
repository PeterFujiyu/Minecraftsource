...
NamedScreenHandlerFactory {
    ...
    private ItemStack resolveBook(ItemStack book, @Nullable PlayerEntity player) {
        ...
        if (world instanceof ServerWorld) {
            ...
            WrittenBookItem.resolve(book, this.getCommandSource(player, lv), player);
        }
        return book;
    }
    ...
    protected void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        ...
        this.book = nbt.contains("Book", NbtElement.COMPOUND_TYPE) ? this.resolveBook(ItemStack.fromNbt(registries, nbt.getCompound("Book")).orElse(ItemStack.EMPTY), null) : ItemStack.EMPTY;
        this.pageCount = LecternBlockEntity.getPageCount(this.book);
