        ...
        protected void readCustomDataFromNbt(NbtCompound nbt) {
            ...
            if (nbt.contains(TEXT_NBT_KEY, NbtElement.STRING_TYPE)) {
                ...
                try {
                    ...
                    if (lv != null && (world = this.getWorld()) instanceof ServerWorld) {
                        ServerWorld lv2 = (ServerWorld)world;
                        ServerCommandSource lv3 = this.getCommandSource(lv2).withLevel(2);
                        MutableText lv4 = Texts.parse(lv3, lv, (Entity)this, 0);
                        this.setText(lv4);
                    } else {
    ...
    extends DisplayEntity {
        ...
        protected void writeCustomDataToNbt(NbtCompound nbt) {
            ...
            if (!this.getItemStack().isEmpty()) {
                nbt.put(ITEM_NBT_KEY, this.getItemStack().toNbt(this.getRegistryManager()));
            }
