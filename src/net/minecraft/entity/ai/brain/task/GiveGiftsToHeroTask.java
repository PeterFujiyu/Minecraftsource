...
extends MultiTickTask<VillagerEntity> {
    ...
    protected void keepRunning(ServerWorld arg, VillagerEntity arg2, long l) {
        ...
        if (this.isCloseEnough(arg2, lv)) {
            if (l - this.startTime > 20L) {
                this.giveGifts(arg, arg2, lv);
                this.done = true;
            }
        } else {
            TargetUtil.walkTowards((LivingEntity)arg2, lv, 0.5f, 5);
        }
    }
    ...
    private static RegistryKey<LootTable> getGiftLootTable(VillagerEntity villager) {
        ...
        return GIFTS.getOrDefault(lv, LootTables.HERO_OF_THE_VILLAGE_UNEMPLOYED_GIFT_GAMEPLAY);
    }
