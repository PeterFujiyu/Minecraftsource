...
public abstract class EntityNavigation {
    ...
    protected Path findPathToAny(Set<BlockPos> positions, int range, boolean useHeadPos, int distance, float followRange) {
        ...
        ChunkCache lv3 = new ChunkCache(this.world, lv2.add(-k, -k, -k), lv2.add(k, k, k));
        Path lv4 = this.pathNodeNavigator.findPathToAny(lv3, this.entity, positions, followRange, distance, this.rangeMultiplier);
        lv.pop();
        if (lv4 != null && lv4.getTarget() != null) {
            this.currentTarget = lv4.getTarget();
    ...
    public boolean isValidPosition(BlockPos pos) {
        ...
        return this.world.getBlockState(lv).isOpaqueFullCube();
    }
