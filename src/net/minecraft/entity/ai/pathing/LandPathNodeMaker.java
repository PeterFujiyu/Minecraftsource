...
extends PathNodeMaker {
    ...
    public int getSuccessors(PathNode[] successors, PathNode node) {
        ...
        for (Direction lv3 : Direction.Type.HORIZONTAL) {
            PathNode lv4;
            this.successors[lv3.getHorizontalQuarterTurns()] = lv4 = this.getPathNode(node.x + lv3.getOffsetX(), node.y, node.z + lv3.getOffsetZ(), j, d, lv3, lv2);
        ...
        for (Direction lv3 : Direction.Type.HORIZONTAL) {
            ...
            if (!this.isValidDiagonalSuccessor(node, this.successors[lv3.getHorizontalQuarterTurns()], this.successors[lv5.getHorizontalQuarterTurns()]) || !this.isValidDiagonalSuccessor(lv6 = this.getPathNode(node.x + lv3.getOffsetX() + lv5.getOffsetX(), node.y, node.z + lv3.getOffsetZ() + lv5.getOffsetZ(), j, d, lv3, lv2))) continue;
            successors[i++] = lv6;
        }
        return i;
    }
