...
extends Goal {
    ...
    private AbstractHorseEntity getHorse(LocalDifficulty localDifficulty) {
        SkeletonHorseEntity lv = EntityType.SKELETON_HORSE.create((World)this.skeletonHorse.getWorld(), SpawnReason.TRIGGERED);
        if (lv != null) {
    ...
    private SkeletonEntity getSkeleton(LocalDifficulty localDifficulty, AbstractHorseEntity vehicle) {
        SkeletonEntity lv = EntityType.SKELETON.create((World)vehicle.getWorld(), SpawnReason.TRIGGERED);
        if (lv != null) {
