...
NamedScreenHandlerFactory {
    ...
    default public void writeInventoryToNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
    ...
    default public void readInventoryFromNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
        this.resetInventory();
    ...
    default public void generateInventoryLoot(@Nullable PlayerEntity player) {
        ...
        if (this.getLootTable() != null && minecraftServer != null) {
            ...
            LootWorldContext.Builder lv2 = new LootWorldContext.Builder((ServerWorld)this.getWorld()).add(LootContextParameters.ORIGIN, this.getPos());
            if (player != null) {
