...
implements Attackable {
    ...
    protected void fall(double heightDifference, boolean onGround, BlockState state, BlockPos landedPosition) {
        ...
        if ((world = this.getWorld()) instanceof ServerWorld) {
            ...
            if (onGround && this.fallDistance > 0.0f) {
                ...
                double e = this.getAttributeValue(EntityAttributes.SAFE_FALL_DISTANCE);
                if ((double)this.fallDistance > e && !state.isAir()) {
                    ...
                    int n = (int)(150.0 * m);
                    lv.spawnParticles(new BlockStateParticleEffect(ParticleTypes.BLOCK, state), f, g, h, n, 0.0, 0.0, 0.0, 0.15f);
                }
            }
        }
    ...
    public void baseTick() {
        ...
        if (this.isAlive()) {
            ...
            if (world2 instanceof ServerWorld) {
                double d;
                ServerWorld lv3 = (ServerWorld)world2;
                ...
                if (bl2) {
                    ...
                    if (this.getAir() == -20) {
                        ...
                        for (int i = 0; i < 8; ++i) {
                            ...
                            this.getWorld().addParticle(ParticleTypes.BUBBLE, this.getX() + e, this.getY() + f, this.getZ() + g, ((Vec3d)lv4).x, ((Vec3d)lv4).y, ((Vec3d)lv4).z);
                        }
            ...
            lv4 = this.getWorld();
            if (lv4 instanceof ServerWorld) {
                ServerWorld lv3 = (ServerWorld)lv4;
                BlockPos lv5 = this.getBlockPos();
                if (!Objects.equal(this.lastBlockPos, lv5)) {
                    this.lastBlockPos = lv5;
                    this.applyMovementEffects(lv3, lv5);
                }
            }
        }
    ...
    public void onEquipStack(EquipmentSlot slot, ItemStack oldStack, ItemStack newStack) {
        ...
        if (!this.isSilent() && lv != null && slot == lv.slot()) {
            this.getWorld().playSound(null, this.getX(), this.getY(), this.getZ(), lv.equipSound(), this.getSoundCategory(), 1.0f, 1.0f, this.random.nextLong());
        }
    ...
    public void remove(Entity.RemovalReason reason) {
        World world;
        if ((reason == Entity.RemovalReason.KILLED || reason == Entity.RemovalReason.DISCARDED) && (world = this.getWorld()) instanceof ServerWorld) {
            ServerWorld lv = (ServerWorld)world;
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (!lv2.update(this, () -> this.onStatusEffectUpgraded(lv2, true, null))) {
                    ...
                    iterator.remove();
                    this.onStatusEffectsRemoved(List.of(lv2));
                    continue;
                }
    ...
    public boolean damage(ServerWorld world, DamageSource source, float amount) {
        ...
        if (bl2) {
            if (bl) {
                world.sendEntityStatus(this, EntityStatuses.BLOCK_WITH_SHIELD);
            } else {
    ...
    protected PlayerEntity setAttackingPlayer(DamageSource damageSource) {
        ...
        if (lv instanceof PlayerEntity) {
            ...
            this.attackingPlayer = lv2;
            return lv2;
        }
        if (lv instanceof WolfEntity && (lv3 = (WolfEntity)lv).isTamed()) {
            PlayerEntity lv4;
            this.playerHitTimer = 100;
            LivingEntity livingEntity = lv3.getOwner();
            this.attackingPlayer = livingEntity instanceof PlayerEntity ? (lv4 = (PlayerEntity)livingEntity) : null;
    ...
    public boolean blockedByShield(DamageSource source) {
        ...
        ItemStack lv3 = this.getBlockingItem();
        if (!source.isIn(DamageTypeTags.BYPASSES_SHIELD) && lv3 != null && lv3.getItem() instanceof ShieldItem && !bl && (lv4 = source.getPosition()) != null) {
            Vec3d lv5 = this.getRotationVector(0.0f, this.getHeadYaw());
            Vec3d lv6 = lv4.relativize(this.getPos());
    ...
    protected void onKilledBy(@Nullable LivingEntity adversary) {
        ...
        if (adversary instanceof WitherEntity) {
            if (lv.getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING)) {
                ...
                if (this.getWorld().getBlockState(lv2).isAir() && lv3.canPlaceAt(this.getWorld(), lv2)) {
                    this.getWorld().setBlockState(lv2, lv3, Block.NOTIFY_ALL);
                    bl = true;
                }
            }
            if (!bl) {
                ItemEntity lv4 = new ItemEntity(this.getWorld(), this.getX(), this.getY(), this.getZ(), new ItemStack(Items.WITHER_ROSE));
    ...
    protected void dropLoot(ServerWorld world, DamageSource damageSource, boolean causedByPlayer) {
        ...
        LootTable lv = world.getServer().getReloadableRegistries().getLootTable(optional.get());
        ...
        if (causedByPlayer && this.attackingPlayer != null) {
            lv2 = lv2.add(LootContextParameters.LAST_DAMAGE_PLAYER, this.attackingPlayer).luck(this.attackingPlayer.getLuck());
        }
        LootWorldContext lv3 = lv2.build(LootContextTypes.ENTITY);
        lv.generateLoot(lv3, this.getLootTableSeed(), stack -> this.dropStack(world, (ItemStack)stack));
    }
    ...
    protected int computeFallDamage(float fallDistance, float damageMultiplier) {
        ...
        float h = (float)this.getAttributeValue(EntityAttributes.SAFE_FALL_DISTANCE);
        float i = fallDistance - h;
        return MathHelper.ceil((double)(i * damageMultiplier) * this.getAttributeValue(EntityAttributes.FALL_DAMAGE_MULTIPLIER));
    }
    ...
    public void addDeathParticles() {
        for (int i = 0; i < 20; ++i) {
            ...
            double g = 10.0;
            this.getWorld().addParticle(ParticleTypes.POOF, this.getParticleX(1.0) - d * 10.0, this.getRandomBodyY() - e * 10.0, this.getParticleZ(1.0) - f * 10.0, d, e, f);
        }
    }
    ...
    private void onDismounted(Entity vehicle) {
        ...
        if (this.isRemoved()) {
            ...
            if (bl) {
                ...
                lv = this.getWorld().findClosestCollision(this, lv3, lv2, this.getWidth(), this.getHeight(), this.getWidth()).map(pos -> pos.add(0.0, -e, 0.0)).orElse(lv);
            }
        } else {
    ...
    private void travelMidAir(Vec3d movementInput) {
        ...
        float f = this.isOnGround() ? this.getWorld().getBlockState(lv).getBlock().getSlipperiness() : 1.0f;
        float g = f * 0.91f;
        Vec3d lv2 = this.applyMovementInput(movementInput, f);
        double d = lv2.y;
        StatusEffectInstance lv3 = this.getStatusEffect(StatusEffects.LEVITATION);
        d = lv3 != null ? (d += (0.05 * (double)(lv3.getAmplifier() + 1) - lv2.y) * 0.2) : (!this.getWorld().isClient || this.getWorld().isChunkLoaded(lv) ? (d -= this.getEffectiveGravity()) : (this.getY() > (double)this.getWorld().getBottomY() ? -0.1 : 0.0));
        if (this.hasNoDrag()) {
    ...
    public void tick() {
        ...
        if (f > 0.0025000002f) {
            ...
            m = MathHelper.abs(MathHelper.wrapDegrees(this.getYaw()) - l);
    ...
    private Map<EquipmentSlot, ItemStack> getEquipmentChanges() {
        ...
        for (EquipmentSlot equipmentSlot : EquipmentSlot.VALUES) {
            ItemStack lv2;
            if (!this.areItemsDifferent(lv2 = (switch (equipmentSlot.getType()) {
                default -> throw new MatchException(null, null);
                case EquipmentSlot.Type.HAND -> this.getSyncedHandStack(equipmentSlot);
                case EquipmentSlot.Type.HUMANOID_ARMOR -> this.getSyncedArmorStack(equipmentSlot);
                case EquipmentSlot.Type.ANIMAL_ARMOR -> this.syncedBodyArmorStack;
            }), lv3 = this.getEquippedStack(equipmentSlot))) continue;
            if (map == null) {
    ...
    public void tickMovement() {
        ...
        if (!((var12_14 = this.getControllingPassenger()) instanceof PlayerEntity)) ** GOTO lbl-1000
        lv5 = (PlayerEntity)var12_14;
        if (this.isAlive()) {
        ...
        var12_14 = this.getWorld();
        if (var12_14 instanceof ServerWorld) {
            lv6 = (ServerWorld)var12_14;
        ...
        if (var12_14 instanceof ServerWorld) {
            lv6 = (ServerWorld)var12_14;
            if (this.hurtByWater() && this.isWet()) {
    ...
    protected void tickCramming() {
        ...
        if (!list.isEmpty()) {
            int i = lv.getGameRules().getInt(GameRules.MAX_ENTITY_CRAMMING);
    ...
    public boolean canSee(Entity entity, RaycastContext.ShapeType shapeType, RaycastContext.FluidHandling fluidHandling, double entityY) {
        ...
        return this.getWorld().raycast(new RaycastContext(lv, lv2, shapeType, fluidHandling, this)).getType() == HitResult.Type.MISS;
    }
    ...
    public float getYaw(float tickDelta) {
        ...
        return MathHelper.lerpAngleDegrees(tickDelta, this.prevHeadYaw, this.headYaw);
    }
    ...
    public ItemStack getBlockingItem() {
        ...
        if (lv.getMaxUseTime(this.activeItemStack, this) - this.itemUseTimeLeft < 5) {
            return null;
        }
        return this.activeItemStack;
    }
