...
Monster {
    ...
    private void moveEntities() {
        ...
        List<Entity> list = this.getWorld().getOtherEntities(this, ShulkerEntity.calculateBoundingBox(this.getScale(), lv, g, f, this.getPos()), EntityPredicates.EXCEPT_SPECTATOR.and(arg -> !arg.isConnectedThroughVehicle(this)));
        for (Entity lv2 : list) {
    ...
    private void spawnNewShulker() {
        ...
        ShulkerEntity lv3 = EntityType.SHULKER.create(this.getWorld(), SpawnReason.BREEDING);
        if (lv3 != null) {
    ...
    public Vec3d getRenderPositionOffset(float tickDelta) {
        ...
        d *= d;
        BlockPos lv = this.getBlockPos();
        double e = (double)(lv.getX() - this.prevAttachedBlock.getX()) * (d *= (double)this.getScale());
