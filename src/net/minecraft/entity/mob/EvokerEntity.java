...
extends SpellcastingIllagerEntity {
    ...
    protected boolean isInSameTeam(Entity other) {
        ...
        if (other instanceof VexEntity && (lv = (VexEntity)other).getOwner() != null) {
            return this.isInSameTeam(lv.getOwner());
        }
        return false;
    }
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        public boolean canStart() {
            ...
            int i = SummonVexGoal.castToServerWorld(EvokerEntity.this.getWorld()).getTargets(VexEntity.class, this.closeVexPredicate, EvokerEntity.this, EvokerEntity.this.getBoundingBox().expand(16.0)).size();
        ...
        protected void castSpell() {
            ...
            for (int i = 0; i < 3; ++i) {
                ...
                VexEntity lv4 = EntityType.VEX.create(EvokerEntity.this.getWorld(), SpawnReason.MOB_SUMMONED);
    ...
    extends SpellcastingIllagerEntity.CastSpellGoal {
        ...
        public boolean canStart() {
            ...
            ServerWorld lv = WololoGoal.castToServerWorld(EvokerEntity.this.getWorld());
            if (!lv.getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING)) {
                return false;
            }
            List<SheepEntity> list = lv.getTargets(SheepEntity.class, this.convertibleSheepPredicate, EvokerEntity.this, EvokerEntity.this.getBoundingBox().expand(16.0, 4.0, 16.0));
            if (list.isEmpty()) {
                return false;
            }
