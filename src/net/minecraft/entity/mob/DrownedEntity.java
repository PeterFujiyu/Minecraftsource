...
implements RangedAttackMob {
    ...
    public void shootAt(LivingEntity target, float pullProgress) {
        ...
        TridentEntity lv3 = new TridentEntity(this.getWorld(), this, lv2);
        ...
        if (world instanceof ServerWorld) {
            ...
            ProjectileEntity.spawnWithVelocity(lv3, lv4, lv2, d, e + h * (double)0.2f, g, 1.6f, 14 - this.getWorld().getDifficulty().getId() * 4);
        }
