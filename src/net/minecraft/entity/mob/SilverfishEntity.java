...
extends HostileEntity {
                    ...
                    while (j <= 10 && j >= -10) {
                        ...
                        while (k <= 10 && k >= -10) {
                            ...
                            if (lv6 instanceof InfestedBlock) {
                                if (CallForHelpGoal.castToServerWorld(lv).getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING)) {
    ...
    extends WanderAroundGoal {
        ...
        public boolean canStart() {
            ...
            if (WanderAndInfestGoal.getServerWorld(this.mob).getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING) && lv.nextInt(WanderAndInfestGoal.toGoalTicks(10)) == 0) {
