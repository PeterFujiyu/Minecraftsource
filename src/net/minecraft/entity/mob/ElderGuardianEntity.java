...
extends GuardianEntity {
    ...
    protected void mobTick(ServerWorld world) {
        ...
        if ((this.age + this.getId()) % 1200 == 0) {
            ...
            List<ServerPlayerEntity> list = StatusEffectUtil.addEffectToPlayersWithinDistance(world, this, this.getPos(), 50.0, lv, 1200);
            list.forEach(player -> player.networkHandler.sendPacket(new GameStateChangeS2CPacket(GameStateChangeS2CPacket.ELDER_GUARDIAN_EFFECT, this.isSilent() ? GameStateChangeS2CPacket.field_33328 : 1.0f)));
        }
