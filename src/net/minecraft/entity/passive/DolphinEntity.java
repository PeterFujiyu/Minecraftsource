...
extends WaterAnimalEntity {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        this.setPitch(0.0f);
        EntityData lv = Objects.requireNonNullElseGet(entityData, () -> new PassiveEntity.PassiveData(0.1f));
        return super.initialize(world, difficulty, spawnReason, lv);
    }

    @Override
    @Nullable
    public DolphinEntity createChild(ServerWorld arg, PassiveEntity arg2) {
        return EntityType.DOLPHIN.create(arg, SpawnReason.BREEDING);
    }
    ...
    protected void loot(ServerWorld world, ItemEntity itemEntity) {
        ItemStack lv;
        if (this.getEquippedStack(EquipmentSlot.MAINHAND).isEmpty() && this.canPickupItem(lv = itemEntity.getStack())) {
