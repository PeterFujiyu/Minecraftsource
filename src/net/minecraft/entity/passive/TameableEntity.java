...
implements Tameable {
    ...
    public void onDeath(DamageSource damageSource) {
        ...
        if (entityView instanceof ServerWorld && (lv = (ServerWorld)entityView).getGameRules().getBoolean(GameRules.SHOW_DEATH_MESSAGES) && (livingEntity = this.getOwner()) instanceof ServerPlayerEntity) {
