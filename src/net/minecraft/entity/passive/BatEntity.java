...
extends AmbientEntity {
    ...
    protected void mobTick(ServerWorld world) {
        ...
        if (this.isRoosting()) {
            ...
            if (world.getBlockState(lv2).isSolidBlock(world, lv)) {
                ...
                if (world.getClosestPlayer(CLOSE_PLAYER_PREDICATE, this) != null) {
                    ...
                    if (!bl) {
                        world.syncWorldEvent(null, WorldEvents.BAT_TAKES_OFF, lv, 0);
                    }
                }
            } else {
                this.setRoosting(false);
            ...
            if (this.random.nextInt(100) == 0 && world.getBlockState(lv2).isSolidBlock(world, lv2)) {
                this.setRoosting(true);
            }
        }
    }
