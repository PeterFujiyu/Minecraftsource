...
public class AllayBrain {
    ...
    private static boolean shouldGoTowardsNoteBlock(LivingEntity allay, Brain<?> brain, GlobalPos pos) {
        ...
        return pos.isWithinRange(lv.getRegistryKey(), allay.getBlockPos(), 1024) && lv.getBlockState(pos.pos()).isOf(Blocks.NOTE_BLOCK) && optional.isPresent();
    }
