...
Saddleable {
    ...
    private void playEatingAnimation() {
        ...
        if (!this.isSilent() && (lv = this.getEatSound()) != null) {
            ((World)this.getWorld()).playSound(null, this.getX(), this.getY(), this.getZ(), lv, this.getSoundCategory(), 1.0f, 1.0f + (this.random.nextFloat() - this.random.nextFloat()) * 0.2f);
        }
    }
    ...
    public boolean handleFallDamage(float fallDistance, float damageMultiplier, DamageSource damageSource) {
        ...
        if (this.hasPassengers()) {
            for (Entity lv : this.getPassengersDeep()) {
                lv.serverDamage(damageSource, i);
            }
        }
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        ...
        BlockState lv = ((World)this.getWorld()).getBlockState(pos.up());
    ...
    public void openInventory(PlayerEntity player) {
        if (!((World)this.getWorld()).isClient && (!this.hasPassengers() || this.hasPassenger(player)) && this.isTame()) {
    ...
    public ActionResult interactHorse(PlayerEntity player, ItemStack stack) {
        ...
        return bl || ((World)this.getWorld()).isClient ? ActionResult.SUCCESS_SERVER : ActionResult.PASS;
    }
    ...
    protected boolean receiveFood(PlayerEntity player, ItemStack item) {
        ...
        if (item.isOf(Items.WHEAT)) {
            ...
            i = 60;
            j = 5;
            if (!((World)this.getWorld()).isClient && this.isTame() && this.getBreedingAge() == 0 && !this.isInLove()) {
                bl = true;
        ...
        if (!(j <= 0 || !bl && this.isTame() || this.getTemper() >= this.getMaxTemper() || ((World)this.getWorld()).isClient)) {
            this.addTemper(j);
            bl = true;
        }
        if (bl) {
    ...
    public void tickMovement() {
        ...
        block9: {
            block8: {
                ...
                if (!(entityView instanceof ServerWorld)) break block8;
                lv = (ServerWorld)entityView;
    ...
    protected void walkToParent(ServerWorld world) {
        AbstractHorseEntity lv;
        if (this.isBred() && this.isBaby() && !this.isEatingGrass() && (lv = world.getClosestEntity(AbstractHorseEntity.class, PARENT_HORSE_PREDICATE, this, this.getX(), this.getY(), this.getZ(), this.getBoundingBox().expand(16.0))) != null && this.squaredDistanceTo(lv) > 4.0) {
        ...
        block0: for (EntityPose lv2 : passenger.getPoses()) {
            ...
            do {
                ...
                if (Dismounting.canDismountInBlock(h)) {
                    ...
                    if (Dismounting.canPlaceEntityAt((CollisionView)((Object)this.getWorld()), passenger, lv3.offset(lv4))) {
