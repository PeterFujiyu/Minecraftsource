...
extends AnimalEntity {
    ...
    public ItemStack getGoatHornStack() {
        ...
        return this.getWorld().getRegistryManager().getOrThrow(RegistryKeys.INSTRUMENT).getRandomEntry(lv2, lv).map(arg -> GoatHornItem.getStackForInstrument(Items.GOAT_HORN, arg)).orElseGet(() -> new ItemStack(Items.GOAT_HORN));
    }
    ...
    protected void playEatSound() {
        this.getWorld().playSoundFromEntity(null, this, this.isScreaming() ? SoundEvents.ENTITY_GOAT_SCREAMING_EAT : SoundEvents.ENTITY_GOAT_EAT, SoundCategory.NEUTRAL, 1.0f, MathHelper.nextBetween(this.getWorld().random, 0.8f, 1.2f));
    }
