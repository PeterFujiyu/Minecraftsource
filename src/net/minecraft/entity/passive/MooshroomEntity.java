...
VariantHolder<Type> {
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        if (this.stewEffects != null) {
            SuspiciousStewEffectsComponent.CODEC.encodeStart(NbtOps.INSTANCE, this.stewEffects).ifSuccess(stewEffects -> nbt.put(STEW_EFFECTS_NBT_KEY, (NbtElement)stewEffects));
        }
    }
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains(STEW_EFFECTS_NBT_KEY, NbtElement.LIST_TYPE)) {
            SuspiciousStewEffectsComponent.CODEC.parse(NbtOps.INSTANCE, nbt.get(STEW_EFFECTS_NBT_KEY)).ifSuccess(stewEffects -> {
