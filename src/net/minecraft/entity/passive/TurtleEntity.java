...
extends AnimalEntity {
    ...
    public static final TargetPredicate.EntityPredicate BABY_TURTLE_ON_LAND_FILTER = (entity, arg2) -> entity.isBaby() && !entity.isTouchingWater();
    ...
    protected void onGrowUp() {
        ...
        World world;
        super.onGrowUp();
        if (!this.isBaby() && (world = this.getWorld()) instanceof ServerWorld && (lv = (ServerWorld)world).getGameRules().getBoolean(GameRules.DO_MOB_LOOT)) {
            this.dropItem(lv, Items.TURTLE_SCUTE, 1);
        }
    }
