...
public class ArmadilloBrain {
    ...
    private static void addIdleActivities(Brain<ArmadilloEntity> brain) {
        brain.setTaskList(Activity.IDLE, ImmutableList.of(Pair.of(0, LookAtMobWithIntervalTask.follow(EntityType.PLAYER, 6.0f, UniformIntProvider.create(30, 60))), Pair.of(1, new BreedTask(EntityType.ARMADILLO, 1.0f, 1)), Pair.of(2, new RandomTask(ImmutableList.of(Pair.of(new TemptTask(armadillo -> Float.valueOf(1.25f), armadillo -> armadillo.isBaby() ? 1.0 : 2.0), 1), Pair.of(WalkTowardsClosestAdultTask.create(WALK_TOWARDS_CLOSEST_ADULT_RANGE, 1.25f), 1)))), Pair.of(3, new LookAroundTask(UniformIntProvider.create(150, 250), 30.0f, 0.0f, 0.0f)), Pair.of(4, new RandomTask(ImmutableMap.of(MemoryModuleType.WALK_TARGET, MemoryModuleState.VALUE_ABSENT), ImmutableList.of(Pair.of(StrollTask.create(1.0f), 1), Pair.of(GoToLookTargetTask.create(1.0f, 3), 1), Pair.of(new WaitTask(30, 60), 1))))));
    }
