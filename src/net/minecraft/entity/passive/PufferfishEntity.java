...
extends FishEntity {
    ...
    public void tickMovement() {
        ...
        if (world instanceof ServerWorld) {
            ...
            if (this.isAlive() && this.getPuffState() > 0) {
                List<MobEntity> list = this.getWorld().getEntitiesByClass(MobEntity.class, this.getBoundingBox().expand(0.3), arg2 -> BLOW_UP_TARGET_PREDICATE.test(lv, this, (LivingEntity)arg2));
    ...
    public void onPlayerCollision(PlayerEntity player) {
        ...
        if (player instanceof ServerPlayerEntity) {
            ...
            if (i > 0 && player.damage(lv.getServerWorld(), this.getDamageSources().mobAttack(this), 1 + i)) {
                if (!this.isSilent()) {
                    lv.networkHandler.sendPacket(new GameStateChangeS2CPacket(GameStateChangeS2CPacket.PUFFERFISH_STING, GameStateChangeS2CPacket.field_33328));
                }
    ...
    extends Goal {
        ...
        public boolean canStart() {
            List<LivingEntity> list = this.pufferfish.getWorld().getEntitiesByClass(LivingEntity.class, this.pufferfish.getBoundingBox().expand(2.0), arg -> BLOW_UP_TARGET_PREDICATE.test(InflateGoal.getServerWorld(this.pufferfish), this.pufferfish, (LivingEntity)arg));
            return !list.isEmpty();
        }
