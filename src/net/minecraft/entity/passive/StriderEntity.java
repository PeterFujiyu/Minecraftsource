...
Saddleable {
    ...
    public StriderEntity createChild(ServerWorld arg, PassiveEntity arg2) {
        return EntityType.STRIDER.create(arg, SpawnReason.BREEDING);
    }
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        if (lv.nextInt(30) == 0) {
            MobEntity lv2 = EntityType.ZOMBIFIED_PIGLIN.create(world.toServerWorld(), SpawnReason.JOCKEY);
            if (lv2 != null) {
            ...
            PassiveEntity lv3 = EntityType.STRIDER.create(world.toServerWorld(), SpawnReason.JOCKEY);
            if (lv3 != null) {
