...
implements VariantHolder<RegistryEntry<FrogVariant>> {
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        Optional.ofNullable(Identifier.tryParse(nbt.getString(VARIANT_KEY))).map(variant -> RegistryKey.of(RegistryKeys.FROG_VARIANT, variant)).flatMap(Registries.FROG_VARIANT::getOptional).ifPresent(this::setVariant);
    }
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        if (lv.isIn(BiomeTags.SPAWNS_COLD_VARIANT_FROGS)) {
            this.setVariant((RegistryEntry<FrogVariant>)Registries.FROG_VARIANT.getOrThrow(FrogVariant.COLD));
        } else if (lv.isIn(BiomeTags.SPAWNS_WARM_VARIANT_FROGS)) {
            this.setVariant((RegistryEntry<FrogVariant>)Registries.FROG_VARIANT.getOrThrow(FrogVariant.WARM));
        } else {
            this.setVariant((RegistryEntry<FrogVariant>)Registries.FROG_VARIANT.getOrThrow(DEFAULT_VARIANT_KEY));
        }
