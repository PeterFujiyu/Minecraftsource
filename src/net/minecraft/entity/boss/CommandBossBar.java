...
extends ServerBossBar {
    ...
    public NbtCompound toNbt(RegistryWrapper.WrapperLookup registries) {
        ...
        lv.putString("Name", Text.Serialization.toJsonString(this.name, registries));
    ...
    public static CommandBossBar fromNbt(NbtCompound nbt, Identifier id, RegistryWrapper.WrapperLookup registries) {
        CommandBossBar lv = new CommandBossBar(id, Text.Serialization.fromJson(nbt.getString("Name"), registries));
