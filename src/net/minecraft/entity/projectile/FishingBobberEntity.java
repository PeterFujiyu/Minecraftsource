...
extends ProjectileEntity {
    ...
    public int use(ItemStack usedItem) {
        ...
        if (this.hookedEntity != null) {
            ...
            LootWorldContext lv2 = new LootWorldContext.Builder((ServerWorld)this.getWorld()).add(LootContextParameters.ORIGIN, this.getPos()).add(LootContextParameters.TOOL, usedItem).add(LootContextParameters.THIS_ENTITY, this).luck((float)this.luckBonus + lv.getLuck()).build(LootContextTypes.FISHING);
