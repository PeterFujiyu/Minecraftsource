...
public final class AffineTransformation {
    ...
    public static final Codec<AffineTransformation> ANY_CODEC = Codec.withAlternative(CODEC, Codecs.MATRIX_4F.xmap(AffineTransformation::new, AffineTransformation::getMatrix));
