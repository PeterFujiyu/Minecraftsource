...
public record AttributeModifiersComponent(List<Entry> modifiers, boolean showInTooltip) {
    ...
    public static final PacketCodec<RegistryByteBuf, AttributeModifiersComponent> PACKET_CODEC = PacketCodec.tuple(Entry.PACKET_CODEC.collect(PacketCodecs.toList()), AttributeModifiersComponent::modifiers, PacketCodecs.BOOLEAN, AttributeModifiersComponent::showInTooltip, AttributeModifiersComponent::new);
