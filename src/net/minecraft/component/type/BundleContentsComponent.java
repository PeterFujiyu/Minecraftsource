...
implements TooltipData {
    ...
    public static class Builder {
        ...
        public void setSelectedStackIndex(int selectedStackIndex) {
            this.selectedStackIndex = this.selectedStackIndex == selectedStackIndex || selectedStackIndex >= this.stacks.size() ? -1 : selectedStackIndex;
        }
        ...
        public ItemStack removeSelected() {
            ...
            int i = this.selectedStackIndex == -1 || this.selectedStackIndex >= this.stacks.size() ? 0 : this.selectedStackIndex;
