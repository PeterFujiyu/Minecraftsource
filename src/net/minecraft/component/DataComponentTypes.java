...
public class DataComponentTypes {
    ...
    public static final ComponentType<Unit> GLIDER = DataComponentTypes.register("glider", builder -> builder.codec(Unit.CODEC).packetCodec(PacketCodec.unit(Unit.INSTANCE)));
    ...
    public static final ComponentType<List<RegistryKey<Recipe<?>>>> RECIPES = DataComponentTypes.register("recipes", builder -> builder.codec(RegistryKey.createCodec(RegistryKeys.RECIPE).listOf()).cache());
