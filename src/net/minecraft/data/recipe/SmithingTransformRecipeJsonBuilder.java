...
public class SmithingTransformRecipeJsonBuilder {
    ...
    public void offerTo(RecipeExporter exporter, RegistryKey<Recipe<?>> recipeKey) {
        ...
        SmithingTransformRecipe lv2 = new SmithingTransformRecipe(Optional.of(this.template), Optional.of(this.base), Optional.of(this.addition), new ItemStack(this.result));
