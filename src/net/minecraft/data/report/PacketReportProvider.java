...
implements DataProvider {
    ...
    private JsonElement toJson() {
        ...
        Stream.of(HandshakeStates.C2S_FACTORY, QueryStates.S2C_FACTORY, QueryStates.C2S_FACTORY, LoginStates.S2C_FACTORY, LoginStates.C2S_FACTORY, ConfigurationStates.S2C_FACTORY, ConfigurationStates.C2S_FACTORY, PlayStateFactories.S2C, PlayStateFactories.C2S).collect(Collectors.groupingBy(NetworkState.Factory::phase)).forEach((phase, states) -> {
