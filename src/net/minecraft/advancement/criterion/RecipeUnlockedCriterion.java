...
extends AbstractCriterion<Conditions> {
    ...
    {
        public static final Codec<Conditions> CODEC = RecordCodecBuilder.create(instance -> instance.group(EntityPredicate.LOOT_CONTEXT_PREDICATE_CODEC.optionalFieldOf("player").forGetter(Conditions::player), ((MapCodec)RegistryKey.createCodec(RegistryKeys.RECIPE).fieldOf("recipe")).forGetter(Conditions::recipe)).apply((Applicative<Conditions, ?>)instance, Conditions::new));
