...
extends AbstractCriterion<Conditions> {
    ...
    public void trigger(ServerPlayerEntity player, BlockPos pos) {
        ...
        LootWorldContext lv3 = new LootWorldContext.Builder(lv).add(LootContextParameters.ORIGIN, pos.toCenterPos()).add(LootContextParameters.THIS_ENTITY, player).add(LootContextParameters.BLOCK_STATE, lv2).build(LootContextTypes.BLOCK_USE);
