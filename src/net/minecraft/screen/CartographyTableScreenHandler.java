...
extends ScreenHandler {
    ...
    public ItemStack quickMove(PlayerEntity player, int slot) {
        ...
        if (lv2 != null && lv2.hasStack()) {
            ...
            } else if (slot == 1 || slot == 0 ? !this.insertItem(lv3, 3, 39, false) : (lv3.contains(DataComponentTypes.MAP_ID) ? !this.insertItem(lv3, 0, 1, false) : (lv3.isOf(Items.PAPER) || lv3.isOf(Items.MAP) || lv3.isOf(Items.GLASS_PANE) ? !this.insertItem(lv3, 1, 2, false) : (slot >= 3 && slot < 30 ? !this.insertItem(lv3, 30, 39, false) : slot >= 30 && slot < 39 && !this.insertItem(lv3, 3, 30, false))))) {
                return ItemStack.EMPTY;
            }
            if (lv3.isEmpty()) {
