...
public class BlockStateModelGenerator {
    ...
    public static final List<Pair<Direction, Function<Identifier, BlockStateVariant>>> CONNECTION_VARIANT_FUNCTIONS = List.of(Pair.of(Direction.NORTH, model -> BlockStateVariant.create().put(VariantSettings.MODEL, model)), Pair.of(Direction.EAST, model -> BlockStateVariant.create().put(VariantSettings.MODEL, model).put(VariantSettings.Y, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true)), Pair.of(Direction.SOUTH, model -> BlockStateVariant.create().put(VariantSettings.MODEL, model).put(VariantSettings.Y, VariantSettings.Rotation.R180).put(VariantSettings.UVLOCK, true)), Pair.of(Direction.WEST, model -> BlockStateVariant.create().put(VariantSettings.MODEL, model).put(VariantSettings.Y, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true)), Pair.of(Direction.UP, model -> BlockStateVariant.create().put(VariantSettings.MODEL, model).put(VariantSettings.X, VariantSettings.Rotation.R270).put(VariantSettings.UVLOCK, true)), Pair.of(Direction.DOWN, model -> BlockStateVariant.create().put(VariantSettings.MODEL, model).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.UVLOCK, true)));
    ...
    private static BlockStateSupplier createMudBrickState(Block block, Identifier modelId, TextureMap textures, BiConsumer<Identifier, ModelSupplier> modelCollector) {
    ...
    private static BlockStateSupplier createDeepslateState(Block block, Identifier modelId, TextureMap textures, BiConsumer<Identifier, ModelSupplier> modelCollector) {
    ...
    public BlockStateModelGenerator(Consumer<BlockStateSupplier> blockStateCollector, ItemModelOutput itemModelOutput, BiConsumer<Identifier, ModelSupplier> modelCollector) {
    ...
    private void registerCreakingHeart(Block block) {
        Function<TexturedModel.Factory, Identifier> function = factory -> factory.andThen(textureMap -> textureMap.put(TextureKey.SIDE, TextureMap.getSubId(block, "_active"))).andThen(textureMap -> textureMap.put(TextureKey.END, TextureMap.getSubId(block, "_top_active"))).upload(block, "_active", this.modelCollector);
        ...
        Identifier lv3 = function.apply(TexturedModel.END_FOR_TOP_CUBE_COLUMN);
        Identifier lv4 = function.apply(TexturedModel.END_FOR_TOP_CUBE_COLUMN_HORIZONTAL);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(block).coordinate(BlockStateVariantMap.create(Properties.AXIS, CreakingHeartBlock.ACTIVE).register(Direction.Axis.Y, (Boolean)false, BlockStateVariant.create().put(VariantSettings.MODEL, lv)).register(Direction.Axis.Z, (Boolean)false, BlockStateVariant.create().put(VariantSettings.MODEL, lv2).put(VariantSettings.X, VariantSettings.Rotation.R90)).register(Direction.Axis.X, (Boolean)false, BlockStateVariant.create().put(VariantSettings.MODEL, lv2).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.Y, VariantSettings.Rotation.R90)).register(Direction.Axis.Y, (Boolean)true, BlockStateVariant.create().put(VariantSettings.MODEL, lv3)).register(Direction.Axis.Z, (Boolean)true, BlockStateVariant.create().put(VariantSettings.MODEL, lv4).put(VariantSettings.X, VariantSettings.Rotation.R90)).register(Direction.Axis.X, (Boolean)true, BlockStateVariant.create().put(VariantSettings.MODEL, lv4).put(VariantSettings.X, VariantSettings.Rotation.R90).put(VariantSettings.Y, VariantSettings.Rotation.R90))));
    }
    ...
    private void registerSunflower() {
        ...
        Identifier lv2 = this.createSubModel(Blocks.SUNFLOWER, "_bottom", CrossType.NOT_TINTED.getCrossModel(), TextureMap::cross);
    ...
    private void registerBeehive(Block beehive, Function<Block, TextureMap> texturesFactory) {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(beehive).coordinate(BlockStateModelGenerator.createNorthDefaultHorizontalRotationStates()).coordinate(BlockStateModelGenerator.createValueFencedModelMap(BeehiveBlock.HONEY_LEVEL, 5, lv4, lv3)));
    }
    ...
    private void registerFire() {
        ...
        this.blockStateCollector.accept(MultipartBlockStateSupplier.create(Blocks.FIRE).with((When)lv, BlockStateModelGenerator.buildBlockStateVariants(list, variant -> variant)).with(When.anyOf(When.create().set(Properties.NORTH, true), lv), BlockStateModelGenerator.buildBlockStateVariants(list2, variant -> variant)).with(When.anyOf(When.create().set(Properties.EAST, true), lv), BlockStateModelGenerator.buildBlockStateVariants(list2, variant -> variant.put(VariantSettings.Y, VariantSettings.Rotation.R90))).with(When.anyOf(When.create().set(Properties.SOUTH, true), lv), BlockStateModelGenerator.buildBlockStateVariants(list2, variant -> variant.put(VariantSettings.Y, VariantSettings.Rotation.R180))).with(When.anyOf(When.create().set(Properties.WEST, true), lv), BlockStateModelGenerator.buildBlockStateVariants(list2, variant -> variant.put(VariantSettings.Y, VariantSettings.Rotation.R270))).with((When)When.create().set(Properties.UP, true), BlockStateModelGenerator.buildBlockStateVariants(list3, variant -> variant)));
    }
    ...
    private void registerSoulFire() {
        ...
        this.blockStateCollector.accept(MultipartBlockStateSupplier.create(Blocks.SOUL_FIRE).with(BlockStateModelGenerator.buildBlockStateVariants(list, variant -> variant)).with(BlockStateModelGenerator.buildBlockStateVariants(list2, variant -> variant)).with(BlockStateModelGenerator.buildBlockStateVariants(list2, variant -> variant.put(VariantSettings.Y, VariantSettings.Rotation.R90))).with(BlockStateModelGenerator.buildBlockStateVariants(list2, variant -> variant.put(VariantSettings.Y, VariantSettings.Rotation.R180))).with(BlockStateModelGenerator.buildBlockStateVariants(list2, variant -> variant.put(VariantSettings.Y, VariantSettings.Rotation.R270))));
    }
    ...
    private void registerTripwireHook() {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.TRIPWIRE_HOOK).coordinate(BlockStateVariantMap.create(Properties.ATTACHED, Properties.POWERED).register((attached, on) -> BlockStateVariant.create().put(VariantSettings.MODEL, TextureMap.getSubId(Blocks.TRIPWIRE_HOOK, (attached != false ? "_attached" : "") + (on != false ? "_on" : ""))))).coordinate(BlockStateModelGenerator.createNorthDefaultHorizontalRotationStates()));
    }
    ...
    private void registerTurtleEgg() {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.TURTLE_EGG).coordinate(BlockStateVariantMap.create(Properties.EGGS, Properties.HATCH).registerVariants((eggs, hatch) -> Arrays.asList(BlockStateModelGenerator.createModelVariantWithRandomHorizontalRotations(this.getTurtleEggModel((Integer)eggs, (Integer)hatch))))));
    }
    ...
    private void registerMultifaceBlockModel(Block block) {
        ...
        When.PropertyCondition lv3 = Util.make(When.create(), arg2 -> CONNECTION_VARIANT_FUNCTIONS.stream().map(Pair::getFirst).map(MultifaceBlock::getProperty).forEach(property -> {
        ...
        for (Pair<Direction, Function<Identifier, BlockStateVariant>> pair : CONNECTION_VARIANT_FUNCTIONS) {
            BooleanProperty lv4 = MultifaceBlock.getProperty(pair.getFirst());
    ...
    private void registerPaleMossCarpet(Block block) {
        ...
        Identifier lv2 = TexturedModel.MOSSY_CARPET_SIDE.get(block).textures(textureMap -> textureMap.put(TextureKey.SIDE, TextureMap.getSubId(block, "_side_tall"))).upload(block, "_side_tall", this.modelCollector);
        Identifier lv3 = TexturedModel.MOSSY_CARPET_SIDE.get(block).textures(textureMap -> textureMap.put(TextureKey.SIDE, TextureMap.getSubId(block, "_side_small"))).upload(block, "_side_small", this.modelCollector);
        MultipartBlockStateSupplier lv4 = MultipartBlockStateSupplier.create(block);
        When.PropertyCondition lv5 = When.create().set(PaleMossCarpetBlock.BOTTOM, false);
        lv4.with((When)When.create().set(PaleMossCarpetBlock.BOTTOM, true), BlockStateVariant.create().put(VariantSettings.MODEL, lv));
        lv4.with((When)lv5, BlockStateVariant.create().put(VariantSettings.MODEL, lv));
        CONNECTION_VARIANT_FUNCTIONS.stream().map(Pair::getFirst).forEach(direction -> {
            EnumProperty<WallShape> lv = PaleMossCarpetBlock.getWallShape(direction);
            if (lv != null && block.getDefaultState().contains(lv)) {
                lv5.set(lv, WallShape.NONE);
            }
        });
        for (Pair<Direction, Function<Identifier, BlockStateVariant>> pair : CONNECTION_VARIANT_FUNCTIONS) {
            Direction lv6 = pair.getFirst();
            EnumProperty<WallShape> lv7 = PaleMossCarpetBlock.getWallShape(lv6);
            if (lv7 == null) continue;
            Function<Identifier, BlockStateVariant> function = pair.getSecond();
            lv4.with((When)When.create().set(lv7, WallShape.TALL), function.apply(lv2));
            lv4.with((When)When.create().set(lv7, WallShape.LOW), function.apply(lv3));
            lv4.with((When)lv5, function.apply(lv2));
        }
    ...
    private void registerHangingMoss(Block block) {
        BlockStateVariantMap lv = BlockStateVariantMap.create(HangingMossBlock.TIP).register(tip -> {
            ...
            TextureMap lv = TextureMap.cross(TextureMap.getSubId(block, string));
            Identifier lv2 = CrossType.NOT_TINTED.getCrossModel().upload(block, string, lv, this.modelCollector);
            return BlockStateVariant.create().put(VariantSettings.MODEL, lv2);
        });
        this.registerItemModel(block);
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(block).coordinate(lv));
    ...
    private void registerShulkerBox(Block shulkerBox, @Nullable DyeColor arg2) {
        ...
        ItemModel.Unbaked lv3 = arg2 != null ? ItemModels.special(lv2, new ShulkerBoxModelRenderer.Unbaked(arg2)) : ItemModels.special(lv2, new ShulkerBoxModelRenderer.Unbaked());
    ...
    private void registerRoots(Block root, Block pottedRoot) {
        ...
        Identifier lv2 = CrossType.NOT_TINTED.getFlowerPotCrossModel().upload(pottedRoot, lv, this.modelCollector);
    ...
    private void registerJigsaw() {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(Blocks.JIGSAW, BlockStateVariant.create().put(VariantSettings.MODEL, lv6)).coordinate(BlockStateVariantMap.create(Properties.ORIENTATION).register(orientation -> this.addJigsawOrientationToVariant((Orientation)orientation, BlockStateVariant.create()))));
    }
    ...
    private void registerLightBlock() {
        ...
        BlockStateVariantMap.SingleProperty<Integer> lv2 = BlockStateVariantMap.create(Properties.LEVEL_15);
        for (int i = 0; i <= 15; ++i) {
            String string = String.format(Locale.ROOT, "_%02d", i);
            Identifier lv3 = TextureMap.getSubId(Items.LIGHT, string);
            lv2.register((Integer)i, BlockStateVariant.create().put(VariantSettings.MODEL, Models.PARTICLE.upload(Blocks.LIGHT, string, TextureMap.particle(lv3), this.modelCollector)));
    ...
    static interface StateFactory {
        public BlockStateSupplier create(Block var1, Identifier var2, TextureMap var3, BiConsumer<Identifier, ModelSupplier> var4);
    }
