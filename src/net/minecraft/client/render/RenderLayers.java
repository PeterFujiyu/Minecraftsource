...
public class RenderLayers {
    private static final Map<Block, RenderLayer> BLOCKS = Util.make(Maps.newHashMap(), map -> {
        ...
        map.put(Blocks.PALE_OAK_LEAVES, lv2);
        ...
        map.put(Blocks.PALE_OAK_SAPLING, lv3);
        ...
        map.put(Blocks.OPEN_EYEBLOSSOM, lv3);
        map.put(Blocks.CLOSED_EYEBLOSSOM, lv3);
        ...
        map.put(Blocks.PALE_OAK_TRAPDOOR, lv3);
        ...
        map.put(Blocks.PALE_MOSS_CARPET, lv3);
        map.put(Blocks.PALE_HANGING_MOSS, lv3);
        map.put(Blocks.GLOW_LICHEN, lv3);
        map.put(Blocks.RESIN_CLUMP, lv3);
        ...
        map.put(Blocks.POTTED_PALE_OAK_SAPLING, lv3);
        ...
        map.put(Blocks.POTTED_OPEN_EYEBLOSSOM, lv3);
        map.put(Blocks.POTTED_CLOSED_EYEBLOSSOM, lv3);
        ...
        map.put(Blocks.PALE_OAK_DOOR, lv3);
    ...
    public static RenderLayer getItemLayer(ItemStack stack) {
        ...
        if (lv instanceof BlockItem) {
            ...
            return RenderLayers.getEntityBlockLayer(lv3.getDefaultState());
        }
        return TexturedRenderLayers.getItemEntityTranslucentCull();
    }
