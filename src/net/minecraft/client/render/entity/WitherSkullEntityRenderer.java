...
extends EntityRenderer<WitherSkullEntity, WitherSkullEntityRenderState> {
    ...
    @Override
    public void render(WitherSkullEntityRenderState arg, MatrixStack arg2, VertexConsumerProvider arg3, int i) {
        arg2.push();
        arg2.scale(-1.0f, -1.0f, 1.0f);
        VertexConsumer lv = arg3.getBuffer(this.model.getLayer(this.getTexture(arg)));
        this.model.setHeadRotation(0.0f, arg.yaw, arg.pitch);
