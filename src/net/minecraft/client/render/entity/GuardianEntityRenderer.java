...
extends MobEntityRenderer<GuardianEntity, GuardianEntityRenderState, GuardianEntityModel> {
    ...
    @Override
    public void render(GuardianEntityRenderState arg, MatrixStack arg2, VertexConsumerProvider arg3, int i) {
        ...
        if (lv != null) {
            ...
            GuardianEntityRenderer.renderBeam(arg2, arg3.getBuffer(LAYER), lv.subtract(arg.cameraPosVec), arg.beamTicks, arg.beamProgress, f);
            arg2.pop();
        }
    }

    private static void renderBeam(MatrixStack matrices, VertexConsumer vertexConsumer, Vec3d arg3, float beamTicks, float g, float h) {
        float i = (float)(arg3.length() + 1.0);
        arg3 = arg3.normalize();
        float j = (float)Math.acos(arg3.y);
        float k = 1.5707964f - (float)Math.atan2(arg3.z, arg3.x);
        matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(k * 57.295776f));
        matrices.multiply(RotationAxis.POSITIVE_X.rotationDegrees(j * 57.295776f));
        ...
        GuardianEntityRenderer.vertex(vertexConsumer, lv, aa, ai, ab, n, o, p, 0.4999f, am);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, aa, 0.0f, ab, n, o, p, 0.4999f, al);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, ac, 0.0f, ad, n, o, p, 0.0f, al);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, ac, ai, ad, n, o, p, 0.0f, am);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, ae, ai, af, n, o, p, 0.4999f, am);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, ae, 0.0f, af, n, o, p, 0.4999f, al);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, ag, 0.0f, ah, n, o, p, 0.0f, al);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, ag, ai, ah, n, o, p, 0.0f, am);
        float an = MathHelper.floor(beamTicks) % 2 == 0 ? 0.5f : 0.0f;
        GuardianEntityRenderer.vertex(vertexConsumer, lv, s, ai, t, n, o, p, 0.5f, an + 0.5f);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, u, ai, v, n, o, p, 1.0f, an + 0.5f);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, y, ai, z, n, o, p, 1.0f, an);
        GuardianEntityRenderer.vertex(vertexConsumer, lv, w, ai, x, n, o, p, 0.5f, an);
    }
