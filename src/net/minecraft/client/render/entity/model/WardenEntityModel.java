...
extends EntityModel<WardenEntityRenderState> {
    ...
    public void setAngles(WardenEntityRenderState arg) {
        super.setAngles(arg);
        this.setHeadAngle(arg.yawDegrees, arg.pitch);
        this.setLimbAngles(arg.limbFrequency, arg.limbAmplitudeMultiplier);
        this.setHeadAndBodyAngles(arg.age);
        this.setTendrilPitches(arg, arg.age);
        this.animate(arg.attackingAnimationState, WardenAnimations.ATTACKING, arg.age);
        this.animate(arg.chargingSonicBoomAnimationState, WardenAnimations.CHARGING_SONIC_BOOM, arg.age);
        this.animate(arg.diggingAnimationState, WardenAnimations.DIGGING, arg.age);
        this.animate(arg.emergingAnimationState, WardenAnimations.EMERGING, arg.age);
        this.animate(arg.roaringAnimationState, WardenAnimations.ROARING, arg.age);
        this.animate(arg.sniffingAnimationState, WardenAnimations.SNIFFING, arg.age);
    }
