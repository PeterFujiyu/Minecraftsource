...
extends ArmorStandArmorEntityModel {
    ...
    public void setAngles(ArmorStandEntityRenderState arg) {
        ...
        this.rightBodyStick.pitch = (float)Math.PI / 180 * arg.bodyRotation.getPitch();
        this.rightBodyStick.yaw = (float)Math.PI / 180 * arg.bodyRotation.getYaw();
        this.rightBodyStick.roll = (float)Math.PI / 180 * arg.bodyRotation.getRoll();
        this.leftBodyStick.pitch = (float)Math.PI / 180 * arg.bodyRotation.getPitch();
        this.leftBodyStick.yaw = (float)Math.PI / 180 * arg.bodyRotation.getYaw();
        this.leftBodyStick.roll = (float)Math.PI / 180 * arg.bodyRotation.getRoll();
        this.shoulderStick.pitch = (float)Math.PI / 180 * arg.bodyRotation.getPitch();
        this.shoulderStick.yaw = (float)Math.PI / 180 * arg.bodyRotation.getYaw();
        this.shoulderStick.roll = (float)Math.PI / 180 * arg.bodyRotation.getRoll();
    }
