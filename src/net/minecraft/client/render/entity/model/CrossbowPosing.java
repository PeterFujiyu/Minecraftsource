...
public class CrossbowPosing {
    ...
    public static void charge(ModelPart holdingArm, ModelPart pullingArm, float f, int i, boolean bl) {
        ModelPart lv = bl ? holdingArm : pullingArm;
        ModelPart lv2 = bl ? pullingArm : holdingArm;
        lv.yaw = bl ? -0.8f : 0.8f;
    ...
    public static void meleeAttack(ModelPart leftArm, ModelPart rightArm, Arm arg3, float swingProgress, float animationProgress) {
