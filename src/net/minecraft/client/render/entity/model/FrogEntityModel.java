...
extends EntityModel<FrogEntityRenderState> {
    ...
    public void setAngles(FrogEntityRenderState arg) {
        super.setAngles(arg);
        this.animate(arg.longJumpingAnimationState, FrogAnimations.LONG_JUMPING, arg.age);
        this.animate(arg.croakingAnimationState, FrogAnimations.CROAKING, arg.age);
        this.animate(arg.usingTongueAnimationState, FrogAnimations.USING_TONGUE, arg.age);
        if (arg.insideWaterOrBubbleColumn) {
            this.animateWalking(FrogAnimations.SWIMMING, arg.limbFrequency, arg.limbAmplitudeMultiplier, 1.0f, 2.5f);
        } else {
            this.animateWalking(FrogAnimations.WALKING, arg.limbFrequency, arg.limbAmplitudeMultiplier, 1.5f, 2.5f);
        }
        this.animate(arg.idlingInWaterAnimationState, FrogAnimations.IDLING_IN_WATER, arg.age);
