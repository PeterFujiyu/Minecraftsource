...
ModelWithHead {
    ...
    public void setAngles(S arg) {
        boolean bl;
        super.setAngles(arg);
        this.head.yaw = ((IllagerEntityRenderState)arg).yawDegrees * ((float)Math.PI / 180);
        ...
        if (((IllagerEntityRenderState)arg).hasVehicle) {
            ...
            float f = ((IllagerEntityRenderState)arg).limbAmplitudeMultiplier;
            float g = ((IllagerEntityRenderState)arg).limbFrequency;
        ...
        if (lv == IllagerEntity.State.ATTACKING) {
            if (((ArmedEntityRenderState)arg).getMainHandItemState().isEmpty()) {
                CrossbowPosing.meleeAttack(this.leftArm, this.rightArm, true, ((IllagerEntityRenderState)arg).handSwingProgress, ((IllagerEntityRenderState)arg).age);
            } else {
                CrossbowPosing.meleeAttack(this.rightArm, this.leftArm, ((IllagerEntityRenderState)arg).illagerMainArm, ((IllagerEntityRenderState)arg).handSwingProgress, ((IllagerEntityRenderState)arg).age);
            }
            ...
            CrossbowPosing.charge(this.rightArm, this.leftArm, ((IllagerEntityRenderState)arg).crossbowPullTime, ((IllagerEntityRenderState)arg).itemUseTime, true);
