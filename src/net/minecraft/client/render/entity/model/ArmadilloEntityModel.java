...
extends EntityModel<ArmadilloEntityRenderState> {
    ...
    public void setAngles(ArmadilloEntityRenderState arg) {
        ...
        if (arg.rolledUp) {
            ...
            this.head.yaw = MathHelper.clamp(arg.yawDegrees, -32.5f, 32.5f) * ((float)Math.PI / 180);
        }
        this.animateWalking(ArmadilloAnimations.IDLE, arg.limbFrequency, arg.limbAmplitudeMultiplier, 16.5f, 2.5f);
        this.animate(arg.unrollingAnimationState, ArmadilloAnimations.UNROLLING, arg.age, 1.0f);
        this.animate(arg.rollingAnimationState, ArmadilloAnimations.ROLLING, arg.age, 1.0f);
        this.animate(arg.scaredAnimationState, ArmadilloAnimations.SCARED, arg.age, 1.0f);
    }
}
