...
extends EntityModel<SnifferEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData lv3 = lv2.addChild(EntityModelPartNames.BONE, ModelPartBuilder.create(), ModelTransform.pivot(0.0f, 5.0f, 0.0f));
    ...
    public void setAngles(SnifferEntityRenderState arg) {
        ...
        if (arg.searching) {
            this.animateWalking(SnifferAnimations.SEARCHING, arg.limbFrequency, arg.limbAmplitudeMultiplier, 9.0f, 100.0f);
        } else {
            this.animateWalking(SnifferAnimations.WALKING, arg.limbFrequency, arg.limbAmplitudeMultiplier, 9.0f, 100.0f);
        }
        this.animate(arg.diggingAnimationState, SnifferAnimations.DIGGING, arg.age);
        this.animate(arg.sniffingAnimationState, SnifferAnimations.SNIFFING, arg.age);
        this.animate(arg.risingAnimationState, SnifferAnimations.RISING, arg.age);
        this.animate(arg.feelingHappyAnimationState, SnifferAnimations.FEELING_HAPPY, arg.age);
        this.animate(arg.scentingAnimationState, SnifferAnimations.SCENTING, arg.age);
        if (arg.baby) {
