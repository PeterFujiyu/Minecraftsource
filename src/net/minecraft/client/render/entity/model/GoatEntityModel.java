...
extends QuadrupedEntityModel<GoatEntityRenderState> {
    ...
    public GoatEntityModel(ModelPart arg) {
        super(arg);
    }
    ...
    @Override
    public void setAngles(GoatEntityRenderState arg) {
        super.setAngles(arg);
        this.head.getChild((String)EntityModelPartNames.LEFT_HORN).visible = arg.hasLeftHorn;
        this.head.getChild((String)EntityModelPartNames.RIGHT_HORN).visible = arg.hasRightHorn;
        if (arg.headPitch != 0.0f) {
            this.head.pitch = arg.headPitch;
        }
    }
}
