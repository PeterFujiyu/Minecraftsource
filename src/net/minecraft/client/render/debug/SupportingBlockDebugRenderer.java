...
implements DebugRenderer.Renderer {
    ...
    private void renderBlockHighlight(BlockPos pos, MatrixStack matrices, double cameraX, double cameraY, double cameraZ, VertexConsumerProvider vertexConsumers, double dilation, float red, float green, float blue) {
        ...
        VertexRendering.drawBox(matrices, vertexConsumers.getBuffer(RenderLayer.getLines()), k, l, m, n, o, p, red, green, blue, 0.4f);
        DebugRenderer.drawVoxelShapeOutlines(matrices, vertexConsumers.getBuffer(RenderLayer.getLines()), this.client.world.getBlockState(pos).getCollisionShape(this.client.world, pos, ShapeContext.absent()).offset(pos.getX(), pos.getY(), pos.getZ()), -cameraX, -cameraY, -cameraZ, red, green, blue, 1.0f, false);
    }
}
