                ...
                for (Map.Entry<Heightmap.Type, Heightmap> entry : lv4.getHeightmaps()) {
                    ...
                    for (int k = 0; k < 16; ++k) {
                        for (int l = 0; l < 16; ++l) {
                            ...
                            VertexRendering.drawFilledBox(matrices, lv2, (double)((float)m + 0.25f) - cameraX, (double)g, (double)((float)n + 0.25f) - cameraZ, (double)((float)m + 0.75f) - cameraX, (double)(g + 0.09375f), (double)((float)n + 0.75f) - cameraZ, vector3f.x(), vector3f.y(), vector3f.z(), 1.0f);
                        }
                    }
                }
            }
