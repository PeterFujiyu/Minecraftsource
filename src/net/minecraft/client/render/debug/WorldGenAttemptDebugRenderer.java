...
implements DebugRenderer.Renderer {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
        ...
        for (int i = 0; i < this.positions.size(); ++i) {
            ...
            VertexRendering.drawFilledBox(matrices, lv, (double)((float)lv2.getX() + 0.5f - g) - cameraX, (double)((float)lv2.getY() + 0.5f - g) - cameraY, (double)((float)lv2.getZ() + 0.5f - g) - cameraZ, (double)((float)lv2.getX() + 0.5f + g) - cameraX, (double)((float)lv2.getY() + 0.5f + g) - cameraY, (double)((float)lv2.getZ() + 0.5f + g) - cameraZ, this.reds.get(i).floatValue(), this.greens.get(i).floatValue(), this.blues.get(i).floatValue(), this.alphas.get(i).floatValue());
        }
    }
}
