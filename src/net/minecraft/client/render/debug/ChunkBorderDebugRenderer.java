...
implements DebugRenderer.Renderer {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
        ...
        float h = (float)((double)(this.client.world.getTopYInclusive() + 1) - cameraY);
        ...
        for (k = this.client.world.getBottomY(); k <= this.client.world.getTopYInclusive() + 1; k += 2) {
        ...
        for (k = this.client.world.getBottomY(); k <= this.client.world.getTopYInclusive() + 1; k += 16) {
            float m = (float)((double)k - cameraY);
