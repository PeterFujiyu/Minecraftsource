    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, double cameraX, double cameraY, double cameraZ) {
        ...
        if (this.structureBoundingBoxes.containsKey(lv2)) {
            for (BlockBox lv5 : this.structureBoundingBoxes.get(lv2).values()) {
                ...
                VertexRendering.drawBox(matrices, lv4, (double)lv5.getMinX() - cameraX, (double)lv5.getMinY() - cameraY, (double)lv5.getMinZ() - cameraZ, (double)(lv5.getMaxX() + 1) - cameraX, (double)(lv5.getMaxY() + 1) - cameraY, (double)(lv5.getMaxZ() + 1) - cameraZ, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f);
            }
        }
        if ((map = this.structurePiecesBoundingBoxes.get(lv2)) != null) {
            for (DebugStructuresCustomPayload.Piece lv6 : map.values()) {
                ...
                if (lv6.isStart()) {
                    VertexRendering.drawBox(matrices, lv4, (double)lv7.getMinX() - cameraX, (double)lv7.getMinY() - cameraY, (double)lv7.getMinZ() - cameraZ, (double)(lv7.getMaxX() + 1) - cameraX, (double)(lv7.getMaxY() + 1) - cameraY, (double)(lv7.getMaxZ() + 1) - cameraZ, 0.0f, 1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 0.0f);
                    continue;
                }
                VertexRendering.drawBox(matrices, lv4, (double)lv7.getMinX() - cameraX, (double)lv7.getMinY() - cameraY, (double)lv7.getMinZ() - cameraZ, (double)(lv7.getMaxX() + 1) - cameraX, (double)(lv7.getMaxY() + 1) - cameraY, (double)(lv7.getMaxZ() + 1) - cameraZ, 0.0f, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f, 1.0f);
            }
        }
    }
