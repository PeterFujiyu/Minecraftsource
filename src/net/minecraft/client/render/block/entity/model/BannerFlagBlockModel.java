...
extends Model {
    ...
    public static TexturedModelData getTexturedModelData(boolean standing) {
        ...
        lv2.addChild("flag", ModelPartBuilder.create().uv(0, 0).cuboid(-10.0f, 0.0f, -2.0f, 20.0f, 40.0f, 1.0f), ModelTransform.pivot(0.0f, standing ? -44.0f : -20.5f, standing ? 0.0f : 10.5f));
