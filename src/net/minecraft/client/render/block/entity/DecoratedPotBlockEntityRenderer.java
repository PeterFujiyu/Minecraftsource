...
implements BlockEntityRenderer<DecoratedPotBlockEntity> {
    ...
    public DecoratedPotBlockEntityRenderer(LoadedEntityModels models) {
        ModelPart lv = models.getModelPart(EntityModelLayers.DECORATED_POT_BASE);
        ...
        ModelPart lv2 = models.getModelPart(EntityModelLayers.DECORATED_POT_SIDES);
    ...
    public void render(DecoratedPotBlockEntity arg, float f, MatrixStack arg2, VertexConsumerProvider arg3, int i, int j) {
        ...
        this.render(arg2, arg3, i, j, arg.getSherds());
        arg2.pop();
    }
    ...
    private void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, Sherds sherds) {
        VertexConsumer lv = TexturedRenderLayers.DECORATED_POT_BASE.getVertexConsumer(vertexConsumers, RenderLayer::getEntitySolid);
        this.neck.render(matrices, lv, light, overlay);
        this.top.render(matrices, lv, light, overlay);
        this.bottom.render(matrices, lv, light, overlay);
