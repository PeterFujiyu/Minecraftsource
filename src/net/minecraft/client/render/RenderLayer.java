...
extends RenderPhase {
    ...
    private static final Function<Identifier, RenderLayer> ARMOR_TRANSLUCENT = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program((RenderPhase.ShaderProgram)((Object)ARMOR_TRANSLUCENT)).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(TRANSLUCENT_TRANSPARENCY).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).layering(VIEW_OFFSET_Z_LAYERING).build(true);
        return RenderLayer.of("armor_translucent", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, 1536, true, true, lv);
    });
    private static final Function<Identifier, RenderLayer> ENTITY_SOLID = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_SOLID_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(NO_TRANSPARENCY).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).build(true);
    ...
    private static final Function<Identifier, RenderLayer> ENTITY_SOLID_Z_OFFSET_FORWARD = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_SOLID_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(NO_TRANSPARENCY).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).layering(VIEW_OFFSET_Z_LAYERING_FORWARD).build(true);
        return RenderLayer.of("entity_solid_z_offset_forward", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, 1536, true, false, lv);
    });
    private static final Function<Identifier, RenderLayer> ENTITY_CUTOUT = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_CUTOUT_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(NO_TRANSPARENCY).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).build(true);
    ...
    private static final BiFunction<Identifier, Boolean, RenderLayer> ENTITY_CUTOUT_NO_CULL = Util.memoize((texture, affectsOutline) -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_CUTOUT_NONULL_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(NO_TRANSPARENCY).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).build((boolean)affectsOutline);
    ...
    private static final BiFunction<Identifier, Boolean, RenderLayer> ENTITY_CUTOUT_NO_CULL_Z_OFFSET = Util.memoize((texture, affectsOutline) -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_CUTOUT_NONULL_OFFSET_Z_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(NO_TRANSPARENCY).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).layering(VIEW_OFFSET_Z_LAYERING).build((boolean)affectsOutline);
    ...
    private static final Function<Identifier, RenderLayer> ITEM_ENTITY_TRANSLUCENT_CULL = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ITEM_ENTITY_TRANSLUCENT_CULL_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(TRANSLUCENT_TRANSPARENCY).target(ITEM_ENTITY_TARGET).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).writeMaskState(ALL_MASK).build(true);
    ...
    private static final BiFunction<Identifier, Boolean, RenderLayer> ENTITY_TRANSLUCENT = Util.memoize((texture, affectsOutline) -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_TRANSLUCENT_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(TRANSLUCENT_TRANSPARENCY).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).build((boolean)affectsOutline);
    ...
    private static final Function<Identifier, RenderLayer> ENTITY_SMOOTH_CUTOUT = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_SMOOTH_CUTOUT_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).build(true);
    ...
    private static final BiFunction<Identifier, Boolean, RenderLayer> BEACON_BEAM = Util.memoize((texture, affectsOutline) -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(BEACON_BEAM_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(affectsOutline != false ? TRANSLUCENT_TRANSPARENCY : NO_TRANSPARENCY).writeMaskState(affectsOutline != false ? COLOR_MASK : ALL_MASK).build(false);
    ...
    private static final Function<Identifier, RenderLayer> ENTITY_DECAL = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_DECAL_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).depthTest(EQUAL_DEPTH_TEST).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).build(false);
    ...
    private static final Function<Identifier, RenderLayer> ENTITY_NO_OUTLINE = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_NO_OUTLINE_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(TRANSLUCENT_TRANSPARENCY).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).writeMaskState(COLOR_MASK).build(false);
    ...
    private static final Function<Identifier, RenderLayer> ENTITY_ALPHA = Util.memoize(texture -> {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ENTITY_ALPHA_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).cull(DISABLE_CULLING).build(true);
    ...
    private static final BiFunction<Identifier, RenderPhase.Transparency, RenderLayer> EYES = Util.memoize((texture, transparency) -> {
        RenderPhase.Texture lv = new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false);
    ...
    private static final RenderLayer DRAGON_RAYS_DEPTH = RenderLayer.of("dragon_rays_depth", VertexFormats.POSITION, VertexFormat.DrawMode.TRIANGLES, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_PROGRAM).writeMaskState(DEPTH_MASK).build(false));
    ...
    private static final RenderLayer NO_CULLING_CLOUDS = RenderLayer.getClouds(false, false);
    private static final RenderLayer FAST_CLOUDS = RenderLayer.getClouds(false, true);
    private static final RenderLayer FANCY_CLOUDS = RenderLayer.getClouds(true, true);
    ...
    public static final MultiPhase SECONDARY_BLOCK_OUTLINE = RenderLayer.of("secondary_block_outline", VertexFormats.LINES, VertexFormat.DrawMode.LINES, 1536, MultiPhaseParameters.builder().program(LINES_PROGRAM).lineWidth(new RenderPhase.LineWidth(OptionalDouble.of(7.0))).layering(VIEW_OFFSET_Z_LAYERING).transparency(RenderPhase.TRANSLUCENT_TRANSPARENCY).target(ITEM_ENTITY_TARGET).writeMaskState(COLOR_MASK).cull(DISABLE_CULLING).build(false));
    ...
    private static final Function<Double, MultiPhase> DEBUG_LINE_STRIP = Util.memoize(lineWidth -> RenderLayer.of("debug_line_strip", VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.DEBUG_LINE_STRIP, 1536, MultiPhaseParameters.builder().program(POSITION_COLOR_PROGRAM).lineWidth(new RenderPhase.LineWidth(OptionalDouble.of(lineWidth))).transparency(NO_TRANSPARENCY).cull(DISABLE_CULLING).build(false)));
    private static final MultiPhase DEBUG_FILLED_BOX = RenderLayer.of("debug_filled_box", VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.TRIANGLE_STRIP, 1536, false, true, MultiPhaseParameters.builder().program(POSITION_COLOR_PROGRAM).layering(VIEW_OFFSET_Z_LAYERING).transparency(TRANSLUCENT_TRANSPARENCY).build(false));
    private static final MultiPhase DEBUG_QUADS = RenderLayer.of("debug_quads", VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.QUADS, 1536, false, true, MultiPhaseParameters.builder().program(POSITION_COLOR_PROGRAM).transparency(TRANSLUCENT_TRANSPARENCY).cull(DISABLE_CULLING).build(false));
    private static final MultiPhase DEBUG_TRIANGLE_FAN = RenderLayer.of("debug_triangle_fan", VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.TRIANGLE_FAN, 1536, false, true, MultiPhaseParameters.builder().program(POSITION_COLOR_PROGRAM).transparency(TRANSLUCENT_TRANSPARENCY).cull(DISABLE_CULLING).build(false));
    ...
    private static final RenderLayer WORLD_BORDER_COLOR_MASK = RenderLayer.createWorldBorder(false);
    private static final RenderLayer WORLD_BORDER_ALL_MASK = RenderLayer.createWorldBorder(true);
    private static final Function<Identifier, RenderLayer> OPAQUE_PARTICLE = Util.memoize(texture -> RenderLayer.of("opaque_particle", VertexFormats.POSITION_TEXTURE_COLOR_LIGHT, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(PARTICLE).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).lightmap(ENABLE_LIGHTMAP).writeMaskState(ALL_MASK).build(false)));
    private static final Function<Identifier, RenderLayer> TRANSLUCENT_PARTICLE = Util.memoize(texture -> RenderLayer.of("translucent_particle", VertexFormats.POSITION_TEXTURE_COLOR_LIGHT, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(PARTICLE).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(TRANSLUCENT_TRANSPARENCY).target(PARTICLES_TARGET).lightmap(ENABLE_LIGHTMAP).writeMaskState(ALL_MASK).build(false)));
    private static final Function<Identifier, RenderLayer> WEATHER_ALL_MASK = RenderLayer.createWeather(true);
    private static final Function<Identifier, RenderLayer> WEATHER_COLOR_MASK = RenderLayer.createWeather(false);
    private static final RenderLayer SKY = RenderLayer.of("sky", VertexFormats.POSITION, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_PROGRAM).writeMaskState(COLOR_MASK).build(false));
    private static final RenderLayer END_SKY = RenderLayer.of("end_sky", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_TEXTURE_COLOR_PROGRAM).texture(new RenderPhase.Texture(SkyRendering.END_SKY_TEXTURE, TriState.FALSE, false)).transparency(TRANSLUCENT_TRANSPARENCY).writeMaskState(COLOR_MASK).build(false));
    private static final RenderLayer SUNRISE_SUNSET = RenderLayer.of("sunrise_sunset", VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.TRIANGLE_FAN, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_COLOR_PROGRAM).transparency(TRANSLUCENT_TRANSPARENCY).writeMaskState(COLOR_MASK).build(false));
    private static final RenderLayer STARS = RenderLayer.of("stars", VertexFormats.POSITION, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_PROGRAM).transparency(OVERLAY_TRANSPARENCY).writeMaskState(COLOR_MASK).build(false));
    private static final Function<Identifier, RenderLayer> CELESTIAL = Util.memoize(texture -> RenderLayer.of("celestial", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_TEXTURE_COLOR_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(OVERLAY_TRANSPARENCY).writeMaskState(COLOR_MASK).build(false)));
    private static final Function<Identifier, RenderLayer> BLOCK_SCREEN_EFFECT = Util.memoize(texture -> RenderLayer.of("block_screen_effect", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_TEXTURE_COLOR_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).depthTest(ALWAYS_DEPTH_TEST).writeMaskState(COLOR_MASK).transparency(TRANSLUCENT_TRANSPARENCY).build(false)));
    private static final Function<Identifier, RenderLayer> FIRE_SCREEN_EFFECT = Util.memoize(texture -> RenderLayer.of("fire_screen_effect", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_TEXTURE_COLOR_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).depthTest(ALWAYS_DEPTH_TEST).writeMaskState(COLOR_MASK).transparency(TRANSLUCENT_TRANSPARENCY).build(false)));
    ...
    private static final Function<Identifier, RenderLayer> GUI_TEXTURED_OVERLAY = Util.memoize(texture -> RenderLayer.of("gui_textured_overlay", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 1536, MultiPhaseParameters.builder().texture(new RenderPhase.Texture((Identifier)texture, TriState.DEFAULT, false)).program(POSITION_TEXTURE_COLOR_PROGRAM).transparency(TRANSLUCENT_TRANSPARENCY).depthTest(ALWAYS_DEPTH_TEST).writeMaskState(COLOR_MASK).build(false)));
    private static final Function<Identifier, RenderLayer> GUI_OPAQUE_TEXTURED_BACKGROUND = Util.memoize(texture -> RenderLayer.of("gui_opaque_textured_background", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 786432, MultiPhaseParameters.builder().texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).program(POSITION_TEXTURE_COLOR_PROGRAM).transparency(NO_TRANSPARENCY).depthTest(LEQUAL_DEPTH_TEST).build(false)));
    private static final MultiPhase GUI_NAUSEA_OVERLAY = RenderLayer.of("gui_nausea_overlay", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 1536, MultiPhaseParameters.builder().texture(new RenderPhase.Texture(InGameHud.NAUSEA_TEXTURE, TriState.DEFAULT, false)).program(POSITION_TEXTURE_COLOR_PROGRAM).transparency(NAUSEA_OVERLAY_TRANSPARENCY).depthTest(ALWAYS_DEPTH_TEST).writeMaskState(COLOR_MASK).build(false));
    ...
    private static final Function<Identifier, RenderLayer> GUI_TEXTURED = Util.memoize(texture -> RenderLayer.of("gui_textured", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 786432, MultiPhaseParameters.builder().texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).program(POSITION_TEXTURE_COLOR_PROGRAM).transparency(TRANSLUCENT_TRANSPARENCY).depthTest(LEQUAL_DEPTH_TEST).build(false)));
    private static final Function<Identifier, RenderLayer> VIGNETTE = Util.memoize(texture -> RenderLayer.of("vignette", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 786432, MultiPhaseParameters.builder().texture(new RenderPhase.Texture((Identifier)texture, TriState.DEFAULT, false)).program(POSITION_TEXTURE_COLOR_PROGRAM).transparency(VIGNETTE_TRANSPARENCY).depthTest(ALWAYS_DEPTH_TEST).writeMaskState(COLOR_MASK).build(false)));
    private static final Function<Identifier, RenderLayer> CROSSHAIR = Util.memoize(texture -> RenderLayer.of("crosshair", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 786432, MultiPhaseParameters.builder().texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).program(POSITION_TEXTURE_COLOR_PROGRAM).transparency(CROSSHAIR_TRANSPARENCY).build(false)));
    private static final MultiPhase MOJANG_LOGO = RenderLayer.of("mojang_logo", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 786432, MultiPhaseParameters.builder().texture(new RenderPhase.Texture(SplashOverlay.LOGO, TriState.DEFAULT, false)).program(POSITION_TEXTURE_COLOR_PROGRAM).transparency(MOJANG_LOGO_TRANSPARENCY).depthTest(ALWAYS_DEPTH_TEST).writeMaskState(COLOR_MASK).build(false));
    ...
    private static MultiPhase createArmorCutoutNoCull(String name, Identifier texture, boolean decal) {
        MultiPhaseParameters lv = MultiPhaseParameters.builder().program(ARMOR_CUTOUT_NO_CULL_PROGRAM).texture(new RenderPhase.Texture(texture, TriState.FALSE, false)).transparency(NO_TRANSPARENCY).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).layering(VIEW_OFFSET_Z_LAYERING).depthTest(decal ? EQUAL_DEPTH_TEST : LEQUAL_DEPTH_TEST).build(true);
    ...
    public static RenderLayer getBreezeWind(Identifier texture, float x, float y) {
        return RenderLayer.of("breeze_wind", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, 1536, false, true, MultiPhaseParameters.builder().program(BREEZE_WIND_PROGRAM).texture(new RenderPhase.Texture(texture, TriState.FALSE, false)).texturing(new RenderPhase.OffsetTexturing(x, y)).transparency(TRANSLUCENT_TRANSPARENCY).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(DISABLE_OVERLAY_COLOR).build(false));
    }

    public static RenderLayer getEnergySwirl(Identifier texture, float x, float y) {
        return RenderLayer.of("energy_swirl", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, 1536, false, true, MultiPhaseParameters.builder().program(ENERGY_SWIRL_PROGRAM).texture(new RenderPhase.Texture(texture, TriState.FALSE, false)).texturing(new RenderPhase.OffsetTexturing(x, y)).transparency(ADDITIVE_TRANSPARENCY).cull(DISABLE_CULLING).lightmap(ENABLE_LIGHTMAP).overlay(ENABLE_OVERLAY_COLOR).build(false));
    }
    ...
    private static MultiPhase getClouds(boolean fancy, boolean culling) {
        return RenderLayer.of("clouds", VertexFormats.POSITION_COLOR, VertexFormat.DrawMode.QUADS, 786432, false, false, MultiPhaseParameters.builder().program(CLOUDS_PROGRAM).transparency(TRANSLUCENT_TRANSPARENCY).cull(culling ? ENABLE_CULLING : DISABLE_CULLING).writeMaskState(fancy ? DEPTH_MASK : ALL_MASK).target(CLOUDS_TARGET).build(true));
    }
    ...
    private static RenderLayer createWorldBorder(boolean allMask) {
        return RenderLayer.of("world_border", VertexFormats.POSITION_TEXTURE, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(POSITION_TEXTURE_PROGRAM).texture(new RenderPhase.Texture(WorldBorderRendering.FORCEFIELD, TriState.FALSE, false)).transparency(OVERLAY_TRANSPARENCY).lightmap(ENABLE_LIGHTMAP).target(WEATHER_TARGET).writeMaskState(allMask ? ALL_MASK : COLOR_MASK).layering(WORLD_BORDER_LAYERING).cull(DISABLE_CULLING).build(false));
    }
    ...
    private static Function<Identifier, RenderLayer> createWeather(boolean allMask) {
        return Util.memoize(texture -> RenderLayer.of("weather", VertexFormats.POSITION_TEXTURE_COLOR_LIGHT, VertexFormat.DrawMode.QUADS, 1536, false, false, MultiPhaseParameters.builder().program(PARTICLE).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).transparency(TRANSLUCENT_TRANSPARENCY).target(WEATHER_TARGET).lightmap(ENABLE_LIGHTMAP).writeMaskState(allMask ? ALL_MASK : COLOR_MASK).cull(DISABLE_CULLING).build(false)));
    }
    ...
    extends RenderLayer {
        static final BiFunction<Identifier, RenderPhase.Cull, RenderLayer> CULLING_LAYERS = Util.memoize((texture, culling) -> RenderLayer.of("outline", VertexFormats.POSITION_TEXTURE_COLOR, VertexFormat.DrawMode.QUADS, 1536, MultiPhaseParameters.builder().program(OUTLINE_PROGRAM).texture(new RenderPhase.Texture((Identifier)texture, TriState.FALSE, false)).cull((RenderPhase.Cull)culling).depthTest(ALWAYS_DEPTH_TEST).target(OUTLINE_TARGET).build(OutlineMode.IS_OUTLINE)));
