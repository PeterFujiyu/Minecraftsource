    ...
    private float[] getRotatedMatrix(Direction direction) {
        ...
        switch (direction) {
            ...
            case DOWN: {
                ...
                fArray2[0] = this.from.x();
                fArray2[1] = 16.0f - this.to.z();
                fArray2[2] = this.to.x();
                fArray = fArray2;
                fArray2[3] = 16.0f - this.from.z();
                break;
            }
            case UP: {
                float[] fArray3 = new float[4];
                fArray3[0] = this.from.x();
                fArray3[1] = this.from.z();
                fArray3[2] = this.to.x();
                fArray = fArray3;
                fArray3[3] = this.to.z();
                break;
            ...
            case NORTH: {
                ...
                fArray4[0] = 16.0f - this.to.x();
                fArray4[1] = 16.0f - this.to.y();
                fArray4[2] = 16.0f - this.from.x();
                fArray = fArray4;
                fArray4[3] = 16.0f - this.from.y();
                break;
            }
            case SOUTH: {
                float[] fArray5 = new float[4];
                fArray5[0] = this.from.x();
                fArray5[1] = 16.0f - this.to.y();
                fArray5[2] = this.to.x();
                fArray = fArray5;
                fArray5[3] = 16.0f - this.from.y();
                break;
            }
            case WEST: {
                float[] fArray6 = new float[4];
                fArray6[0] = this.from.z();
                fArray6[1] = 16.0f - this.to.y();
                fArray6[2] = this.to.z();
                fArray = fArray6;
                fArray6[3] = 16.0f - this.from.y();
                break;
            }
            case EAST: {
                float[] fArray7 = new float[4];
                fArray7[0] = 16.0f - this.to.z();
                fArray7[1] = 16.0f - this.to.y();
                fArray7[2] = 16.0f - this.from.z();
                fArray = fArray7;
                fArray7[3] = 16.0f - this.from.y();
            }
        }
        return fArray;
    }
