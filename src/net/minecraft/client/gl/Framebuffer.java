...
public abstract class Framebuffer {
    ...
    public void drawInternal(int width, int height) {
        ...
        ShaderProgram lv = Objects.requireNonNull(RenderSystem.setShader(ShaderProgramKeys.BLIT_SCREEN), "Blit shader not loaded");
        lv.addSamplerTexture("InSampler", this.colorAttachment);
        BufferBuilder lv2 = RenderSystem.renderThreadTesselator().begin(VertexFormat.DrawMode.QUADS, VertexFormats.BLIT_SCREEN);
        lv2.vertex(0.0f, 0.0f, 0.0f);
        lv2.vertex(1.0f, 0.0f, 0.0f);
        lv2.vertex(1.0f, 1.0f, 0.0f);
        lv2.vertex(0.0f, 1.0f, 0.0f);
