...
extends AnimatedParticle {
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i) {
            return new SquidInkParticle(arg2, d, e, f, g, h, i, ColorHelper.getArgb(255, 204, 31, 102), this.spriteProvider);
        }
    ...
    implements ParticleFactory<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType arg, ClientWorld arg2, double d, double e, double f, double g, double h, double i) {
            return new SquidInkParticle(arg2, d, e, f, g, h, i, ColorHelper.getArgb(255, 255, 255, 255), this.spriteProvider);
        }
