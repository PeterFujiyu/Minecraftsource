...
extends ValueObject {
    ...
    public static RealmsWorldOptions create(LevelInfo levelInfo, String version) {
        return RealmsWorldOptions.create(levelInfo.getGameMode(), levelInfo.getDifficulty(), levelInfo.isHardcore(), version, levelInfo.getLevelName());
    }
