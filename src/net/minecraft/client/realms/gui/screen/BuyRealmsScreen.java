...
extends RealmsScreen {
    ...
    public static void drawTrialAvailableTexture(DrawContext context, ButtonWidget button) {
        ...
        context.drawGuiTexture(RenderLayer::getGuiTextured, TRIAL_AVAILABLE_TEXTURE, button.getX() + button.getWidth() - 8 - 4, button.getY() + button.getHeight() / 2 - 4, 8, 8);
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (!realmsImages.isEmpty()) {
            context.drawTexture(RenderLayer::getGuiTextured, realmsImages.get(this.realmsImageIndex), this.getLeft() + 10, this.getTop() + 10, 0.0f, 0.0f, 195, 152, 195, 152);
        }
    }
