...
extends RealmsScreen {
    ...
    private void drawSlotFrame(DrawContext context, int x, int y, int mouseX, int mouseY, boolean activeSlot, String slotName, int slotId, long templateId, @Nullable String templateImage, boolean empty) {
        ...
        if (activeSlot) {
            ...
            context.drawTexture(RenderLayer::getGuiTextured, lv, x + 3, y + 3, 0.0f, 0.0f, 74, 74, 74, 74, 74, 74, ColorHelper.fromFloats(1.0f, f, f, f));
            ...
            context.drawTexture(RenderLayer::getGuiTextured, lv, x + 3, y + 3, 0.0f, 0.0f, 74, 74, 74, 74, 74, 74, o);
            context.drawGuiTexture(RenderLayer::getGuiTextured, SLOT_FRAME_TEXTURE, x, y, 80, 80, o);
        }
