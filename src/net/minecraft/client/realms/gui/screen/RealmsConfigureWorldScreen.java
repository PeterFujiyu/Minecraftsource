...
extends RealmsScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (this.isMinigame() && (string2 = this.server.getMinigameName()) != null) {
            context.drawTextWithShadow(this.textRenderer, Text.translatable("mco.configure.world.minigame", string2), this.left_x + 80 + 20 + 10, RealmsConfigureWorldScreen.row(13), Colors.WHITE);
        }
    }
    ...
    public void saveSlotSettings(RealmsWorldOptions options) {
        ...
        try {
            ...
            if (lv.gameMode != options.gameMode || lv.hardcore != options.hardcore) {
    ...
    public void saveSettings(String name, String desc) {
        String string3 = StringHelper.isBlank(desc) ? "" : desc;
        RealmsClient lv = RealmsClient.create();
        try {
