...
extends RealmsScreen {
    ...
    extends ButtonWidget {
        ...
        public void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
            ...
            int l = this.getX();
            int m = this.getY();
            context.drawTexture(RenderLayer::getGuiTextured, this.image, l + 2, m + 2, 0.0f, 0.0f, 56, 56, 56, 56, 56, 56, k);
            context.drawGuiTexture(RenderLayer::getGuiTextured, TEXTURE, l, m, 60, 60, k);
