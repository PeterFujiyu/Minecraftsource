...
public class SpectatorMenu {
    ...
    implements SpectatorMenuCommand {
        ...
        @Override
        public void renderIcon(DrawContext context, float brightness, float alpha) {
            context.drawGuiTexture(RenderLayer::getGuiTextured, CLOSE_TEXTURE, 0, 0, 16, 16, ColorHelper.fromFloats(alpha, brightness, brightness, brightness));
        }
    ...
    implements SpectatorMenuCommand {
        ...
        public void renderIcon(DrawContext context, float brightness, float alpha) {
            ...
            if (this.direction < 0) {
                context.drawGuiTexture(RenderLayer::getGuiTextured, SCROLL_LEFT_TEXTURE, 0, 0, 16, 16, i);
            } else {
                context.drawGuiTexture(RenderLayer::getGuiTextured, SCROLL_RIGHT_TEXTURE, 0, 0, 16, 16, i);
            }
        }
