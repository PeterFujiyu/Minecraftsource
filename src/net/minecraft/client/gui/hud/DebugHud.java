...
public class DebugHud {
    ...
    public void render(DrawContext context) {
        ...
        this.fluidHit = lv2.raycast(20.0, 0.0f, true);
        ...
        try (ScopedProfiler lv3 = lv.scoped("profilerPie");){
    ...
    protected List<String> getLeftText() {
        ...
        if (lv11.isEmpty()) {
            ...
            list.add(stringBuilder.toString());
            if (this.client.world.isInHeightLimit(lv6.getY())) {
        ...
        if (lv15 != null) {
            ...
            lv17.appendDebugHudText(list, lv18, lv6);
        ...
        if ((lv22 = this.client.gameRenderer.getPostProcessorId()) != null) {
            list.add("Post: " + String.valueOf(lv22));
        }
