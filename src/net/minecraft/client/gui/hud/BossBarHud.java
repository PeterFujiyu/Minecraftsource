...
public class BossBarHud {
    ...
    public void render(DrawContext context) {
        ...
        int j = 12;
        for (ClientBossBar lv2 : this.bossBars.values()) {
            int k = i / 2 - 91;
            int l = j;
            this.renderBossBar(context, k, l, lv2);
            Text lv3 = lv2.getName();
            int m = this.client.textRenderer.getWidth(lv3);
            int n = i / 2 - m / 2;
            int o = l - 9;
            context.drawTextWithShadow(this.client.textRenderer, lv3, n, o, 0xFFFFFF);
