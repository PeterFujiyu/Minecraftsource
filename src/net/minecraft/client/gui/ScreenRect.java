...
public record ScreenRect(ScreenPos position, int width, int height) {
    ...
    public ScreenRect transform(Matrix4f positionMatrix) {
        ...
        return new ScreenRect(MathHelper.floor(vector3f.x), MathHelper.floor(vector3f.y), MathHelper.floor(vector3f2.x - vector3f.x), MathHelper.floor(vector3f2.y - vector3f.y));
    }
}
