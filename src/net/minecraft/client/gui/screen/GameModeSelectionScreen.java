...
extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, TEXTURE, k, l, 0.0f, 0.0f, 125, 75, 128, 128);
    ...
    extends ClickableWidget {
        ...
        private void drawBackground(DrawContext context) {
            context.drawGuiTexture(RenderLayer::getGuiTextured, SLOT_TEXTURE, this.getX(), this.getY(), 26, 26);
        }

        private void drawSelectionBox(DrawContext context) {
            context.drawGuiTexture(RenderLayer::getGuiTextured, SELECTION_TEXTURE, this.getX(), this.getY(), 26, 26);
        }
    }
}
