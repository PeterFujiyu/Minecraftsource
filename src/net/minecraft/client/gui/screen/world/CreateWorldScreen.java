...
extends Screen {
    ...
    public static void show(MinecraftClient client, @Nullable Screen parent, CreateWorldCallback callback) {
        ...
        CreateWorldScreen.show(client, parent, function, lv, WorldPresets.DEFAULT, callback);
    }
    ...
    public static void showTestWorld(MinecraftClient client, @Nullable Screen parent) {
        ...
        CreateWorldScreen.show(client, parent, function, lv, WorldPresets.FLAT, (screen, combinedDynamicRegistries, levelProperties, dataPackTempDir) -> screen.startServer(combinedDynamicRegistries, levelProperties));
    }
    ...
    private static void show(MinecraftClient client, @Nullable Screen parent, Function<SaveLoading.LoadContextSupplierContext, WorldGenSettings> settingsSupplier, GeneratorOptionsFactory generatorOptionsFactory, RegistryKey<WorldPreset> presetKey, CreateWorldCallback callback) {
        ...
        CompletableFuture<GeneratorOptionsHolder> completableFuture = SaveLoading.load(lv2, context -> new SaveLoading.LoadContext<WorldCreationSettings>(new WorldCreationSettings((WorldGenSettings)settingsSupplier.apply(context), context.dataConfiguration()), context.dimensionsRegistryManager()), (resourceManager, dataPackContents, dynamicRegistries, settings) -> {
    ...
    public static CreateWorldScreen create(MinecraftClient client, @Nullable Screen parent, LevelInfo levelInfo, GeneratorOptionsHolder generatorOptionsHolder, @Nullable Path dataPackTempDir2) {
        CreateWorldScreen lv = new CreateWorldScreen(client, parent, generatorOptionsHolder, WorldPresets.getWorldPreset(generatorOptionsHolder.selectedDimensions()), OptionalLong.of(generatorOptionsHolder.generatorOptions().getSeed()), (screen, combinedDynamicRegistries, levelProperties, dataPackTempDir) -> screen.startServer(combinedDynamicRegistries, levelProperties));
        lv.recreated = true;
