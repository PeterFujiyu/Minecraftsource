...
extends Screen {
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawGuiTexture(RenderLayer::getGuiTextured, BACKGROUND_TEXTURE, k, 64, 236, this.getScreenHeight() + 16);
        context.drawGuiTexture(RenderLayer::getGuiTextured, SEARCH_ICON_TEXTURE, k + 10, 76, 12, 12);
    }
