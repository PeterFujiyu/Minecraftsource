...
extends AlwaysSelectedEntryListWidget<Entry> {
    ...
    extends Entry {
        ...
        public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            context.drawTextWithShadow(this.client.textRenderer, LAN_SCANNING_TEXT, this.client.currentScreen.width / 2 - this.client.textRenderer.getWidth(LAN_SCANNING_TEXT) / 2, p, Colors.WHITE);
            String string = LoadingDisplay.get(Util.getMeasuringTimeMs());
            context.drawTextWithShadow(this.client.textRenderer, string, this.client.currentScreen.width / 2 - this.client.textRenderer.getWidth(string) / 2, p + this.client.textRenderer.fontHeight, Colors.GRAY);
        }
    ...
    extends Entry {
        ...
        public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            for (p = 0; p < Math.min(list.size(), 2); ++p) {
                context.drawTextWithShadow(this.client.textRenderer, list.get(p), x + 32 + 3, y + 12 + this.client.textRenderer.fontHeight * p, -8355712);
            }
            ...
            if (this.statusIconTexture != null) {
                context.drawGuiTexture(RenderLayer::getGuiTextured, this.statusIconTexture, p, y, 10, 8);
            }
            ...
            int r = p - q - 5;
            context.drawTextWithShadow(this.client.textRenderer, lv, r, y + 1, Colors.GRAY);
    ...
    extends Entry {
        ...
        public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            if (this.client.options.hideServerAddress) {
                context.drawTextWithShadow(this.client.textRenderer, HIDDEN_ADDRESS_TEXT, x + 32 + 3, y + 12 + 11, 0x303030);
            } else {
                context.drawTextWithShadow(this.client.textRenderer, this.server.getAddressPort(), x + 32 + 3, y + 12 + 11, 0x303030);
            }
        }
