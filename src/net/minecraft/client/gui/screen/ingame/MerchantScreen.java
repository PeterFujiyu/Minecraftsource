...
extends HandledScreen<MerchantScreenHandler> {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, TEXTURE, k, l, 0.0f, 0.0f, this.backgroundWidth, this.backgroundHeight, 512, 256);
    ...
    private void drawLevelInfo(DrawContext context, int x, int y, TradeOffer tradeOffer) {
        ...
        context.drawGuiTexture(RenderLayer::getGuiTextured, EXPERIENCE_BAR_CURRENT_TEXTURE, 102, 5, 0, 0, x + 136, y + 16, o, 5);
        int p = ((MerchantScreenHandler)this.handler).getMerchantRewardedExperience();
        if (p > 0) {
            int q = Math.min(MathHelper.floor((float)p * f), 102 - o);
            context.drawGuiTexture(RenderLayer::getGuiTextured, EXPERIENCE_BAR_RESULT_TEXTURE, 102, 5, o, 0, x + 136 + o, y + 16, q, 5);
        }
    }
    ...
    private void renderScrollbar(DrawContext context, int x, int y, TradeOfferList tradeOffers) {
        ...
        if (k > 1) {
            ...
            context.drawGuiTexture(RenderLayer::getGuiTextured, SCROLLER_TEXTURE, x + 94, y + 18 + o, 6, 27);
        } else {
