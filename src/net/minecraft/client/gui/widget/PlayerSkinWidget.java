...
extends ClickableWidget {
    ...
    public PlayerSkinWidget(int width, int height, LoadedEntityModels entityModels, Supplier<SkinTextures> skinSupplier) {
        ...
        this.models = Models.create(entityModels);
    ...
    record Models(PlayerEntityModel wideModel, PlayerEntityModel slimModel) {
        public static Models create(LoadedEntityModels entityModels) {
            PlayerEntityModel lv = new PlayerEntityModel(entityModels.getModelPart(EntityModelLayers.PLAYER), false);
            PlayerEntityModel lv2 = new PlayerEntityModel(entityModels.getModelPart(EntityModelLayers.PLAYER_SLIM), true);
        ...
        public void draw(DrawContext context, SkinTextures skinTextures) {
            ...
            context.draw(vertexConsumers -> lv.render(context.getMatrices(), vertexConsumers.getBuffer(lv2), 0xF000F0, OverlayTexture.DEFAULT_UV));
            context.getMatrices().pop();
        }
    }
}
