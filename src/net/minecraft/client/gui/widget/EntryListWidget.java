...
extends ContainerWidget {
    ...
    public void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (this.renderHeader) {
            ...
            int l = this.getY() + 4 - (int)this.getScrollY();
    ...
    protected void drawHeaderAndFooterSeparators(DrawContext context) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, lv, this.getX(), this.getY() - 2, 0.0f, 0.0f, this.getWidth(), 2, 32, 2);
        context.drawTexture(RenderLayer::getGuiTextured, lv2, this.getX(), this.getBottom(), 0.0f, 0.0f, this.getWidth(), 2, 32, 2);
    }

    protected void drawMenuListBackground(DrawContext context) {
        Identifier lv = this.client.world == null ? MENU_LIST_BACKGROUND_TEXTURE : INWORLD_MENU_LIST_BACKGROUND_TEXTURE;
        context.drawTexture(RenderLayer::getGuiTextured, lv, this.getX(), this.getY(), this.getRight(), this.getBottom() + (int)this.getScrollY(), this.getWidth(), this.getHeight(), 32, 32);
    }
