    ...
    protected void renderContents(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (EditBox.Substring lv : this.editBox.getLines()) {
            ...
            if (bl && bl2 && k >= lv.beginIndex() && k <= lv.endIndex()) {
                if (bl3) {
                    l = context.drawTextWithShadow(this.textRenderer, string.substring(lv.beginIndex(), k), this.getTextX(), n, -2039584) - 1;
                ...
                if (bl3) {
                    l = context.drawTextWithShadow(this.textRenderer, string.substring(lv.beginIndex(), lv.endIndex()), this.getTextX(), n, -2039584) - 1;
                }
                m = n;
            }
        ...
        if (this.editBox.hasSelection()) {
            ...
            for (EditBox.Substring lv3 : this.editBox.getLines()) {
                ...
                if (this.isVisible(n, n + this.textRenderer.fontHeight)) {
                    ...
                    int q = lv2.endIndex() > lv3.endIndex() ? this.width - this.getTextMargin() : this.textRenderer.getWidth(string.substring(lv3.beginIndex(), lv2.endIndex()));
