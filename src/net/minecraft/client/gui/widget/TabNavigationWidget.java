...
Selectable {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        context.drawTexture(RenderLayer::getGuiTextured, Screen.HEADER_SEPARATOR_TEXTURE, 0, this.grid.getY() + this.grid.getHeight() - 2, 0.0f, 0.0f, ((TabButtonWidget)this.tabButtons.get(0)).getX(), 2, 32, 2);
        int k = ((TabButtonWidget)this.tabButtons.get(this.tabButtons.size() - 1)).getRight();
        context.drawTexture(RenderLayer::getGuiTextured, Screen.HEADER_SEPARATOR_TEXTURE, k, this.grid.getY() + this.grid.getHeight() - 2, 0.0f, 0.0f, this.tabNavWidth, 2, 32, 2);
