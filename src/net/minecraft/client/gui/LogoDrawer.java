...
public class LogoDrawer {
    ...
    public void draw(DrawContext context, int screenWidth, float alpha, int y) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, this.minceraft ? MINCERAFT_TEXTURE : LOGO_TEXTURE, k, y, 0.0f, 0.0f, 256, 44, 256, 64, l);
        int m = screenWidth / 2 - 64;
        int n = y + 44 - 7;
        context.drawTexture(RenderLayer::getGuiTextured, EDITION_TEXTURE, m, n, 0.0f, 0.0f, 128, 14, 128, 16, l);
    }
}
