...
public abstract class StructurePiece {
    ...
    private static final Set<Block> BLOCKS_NEEDING_POST_PROCESSING = ((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().add(Blocks.NETHER_BRICK_FENCE)).add(Blocks.TORCH)).add(Blocks.WALL_TORCH)).add(Blocks.OAK_FENCE)).add(Blocks.SPRUCE_FENCE)).add(Blocks.DARK_OAK_FENCE)).add(Blocks.PALE_OAK_FENCE)).add(Blocks.ACACIA_FENCE)).add(Blocks.BIRCH_FENCE)).add(Blocks.JUNGLE_FENCE)).add(Blocks.LADDER)).add(Blocks.IRON_BARS)).build();
    ...
    public final NbtCompound toNbt(StructureContext context) {
        ...
        lv.putInt("O", lv2 == null ? -1 : lv2.getHorizontalQuarterTurns());
    ...
    public static BlockState orientateChest(BlockView world, BlockPos pos, BlockState state) {
        ...
        for (Direction lv2 : Direction.Type.HORIZONTAL) {
            ...
            if (!lv4.isOpaqueFullCube()) continue;
            if (lv == null) {
                lv = lv2;
                continue;
            }
        ...
        if (world.getBlockState(lv6).isOpaqueFullCube()) {
            lv5 = lv5.getOpposite();
            lv6 = pos.offset(lv5);
        }
        if (world.getBlockState(lv6).isOpaqueFullCube()) {
