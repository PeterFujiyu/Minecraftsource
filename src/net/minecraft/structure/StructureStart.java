...
public final class StructureStart {
    ...
    public static StructureStart fromNbt(StructureContext context, NbtCompound nbt, long seed) {
        ...
        Structure lv2 = (Structure)lv.get(Identifier.of(string));
        if (lv2 == null) {
    ...
    public NbtCompound toNbt(StructureContext context, ChunkPos chunkPos) {
        ...
        lv.putString("id", context.registryManager().getOrThrow(RegistryKeys.STRUCTURE).getId(this.structure).toString());
