...
extends ShiftableStructurePiece {
    ...
    public void generate(StructureWorldAccess world, StructureAccessor structureAccessor, ChunkGenerator chunkGenerator, Random random, BlockBox chunkBox, ChunkPos chunkPos, BlockPos pivot) {
        ...
        for (Direction lv5 : Direction.Type.HORIZONTAL) {
            if (this.hasPlacedChest[lv5.getHorizontalQuarterTurns()]) continue;
            int m = lv5.getOffsetX() * 2;
            int n = lv5.getOffsetZ() * 2;
            this.hasPlacedChest[lv5.getHorizontalQuarterTurns()] = this.addChest(world, chunkBox, random, 10 + m, -11, 10 + n, LootTables.DESERT_PYRAMID_CHEST);
        }
