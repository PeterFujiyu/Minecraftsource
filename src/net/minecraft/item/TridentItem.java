...
implements ProjectileItem {
    ...
    public boolean onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (world instanceof ServerWorld) {
            ...
            stack.damage(1, lv);
            if (f == 0.0f) {
                TridentEntity lv4 = ProjectileEntity.spawnWithVelocity(TridentEntity::new, lv3, stack, lv, 0.0f, 2.5f, 1.0f);
                ...
                world.playSoundFromEntity(null, lv4, lv2.value(), SoundCategory.PLAYERS, 1.0f, 1.0f);
                return true;
            }
        }
        if (f > 0.0f) {
