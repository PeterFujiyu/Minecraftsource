...
public class ArmorTrimMaterials {
    ...
    public static void bootstrap(Registerable<ArmorTrimMaterial> registry) {
        ArmorTrimMaterials.register(registry, QUARTZ, Items.QUARTZ, Style.EMPTY.withColor(14931140));
        ArmorTrimMaterials.register(registry, IRON, Items.IRON_INGOT, Style.EMPTY.withColor(0xECECEC), Map.of(EquipmentAssetKeys.IRON, "iron_darker"));
        ArmorTrimMaterials.register(registry, NETHERITE, Items.NETHERITE_INGOT, Style.EMPTY.withColor(6445145), Map.of(EquipmentAssetKeys.NETHERITE, "netherite_darker"));
        ArmorTrimMaterials.register(registry, REDSTONE, Items.REDSTONE, Style.EMPTY.withColor(9901575));
        ArmorTrimMaterials.register(registry, COPPER, Items.COPPER_INGOT, Style.EMPTY.withColor(11823181));
        ArmorTrimMaterials.register(registry, GOLD, Items.GOLD_INGOT, Style.EMPTY.withColor(14594349), Map.of(EquipmentAssetKeys.GOLD, "gold_darker"));
        ArmorTrimMaterials.register(registry, EMERALD, Items.EMERALD, Style.EMPTY.withColor(1155126));
        ArmorTrimMaterials.register(registry, DIAMOND, Items.DIAMOND, Style.EMPTY.withColor(7269586), Map.of(EquipmentAssetKeys.DIAMOND, "diamond_darker"));
        ArmorTrimMaterials.register(registry, LAPIS, Items.LAPIS_LAZULI, Style.EMPTY.withColor(4288151));
        ArmorTrimMaterials.register(registry, AMETHYST, Items.AMETHYST_SHARD, Style.EMPTY.withColor(10116294));
        ArmorTrimMaterials.register(registry, RESIN, Items.RESIN_BRICK, Style.EMPTY.withColor(16545810));
    }
    ...
    public static Optional<RegistryEntry.Reference<ArmorTrimMaterial>> get(RegistryWrapper.WrapperLookup registries, ItemStack stack) {
        return registries.getOrThrow(RegistryKeys.TRIM_MATERIAL).streamEntries().filter(recipe -> stack.itemMatches(((ArmorTrimMaterial)recipe.value()).ingredient())).findFirst();
    }
    ...
    private static void register(Registerable<ArmorTrimMaterial> registry, RegistryKey<ArmorTrimMaterial> key, Item ingredient, Style style) {
        ArmorTrimMaterials.register(registry, key, ingredient, style, Map.of());
    }
    ...
    private static void register(Registerable<ArmorTrimMaterial> registry, RegistryKey<ArmorTrimMaterial> key, Item ingredient, Style style, Map<RegistryKey<EquipmentAsset>, String> overrideArmorAssets) {
        ArmorTrimMaterial lv = ArmorTrimMaterial.of(key.getValue().getPath(), ingredient, Text.translatable(Util.createTranslationKey("trim_material", key.getValue())).fillStyle(style), overrideArmorAssets);
