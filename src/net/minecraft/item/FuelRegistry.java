...
public class FuelRegistry {
    ...
    public int getFuelTicks(ItemStack item) {
        ...
        return this.fuelValues.getInt(item.getItem());
    }
    ...
    public static class Builder {
        ...
        private final Object2IntSortedMap<Item> fuelValues = new Object2IntLinkedOpenHashMap<Item>();
