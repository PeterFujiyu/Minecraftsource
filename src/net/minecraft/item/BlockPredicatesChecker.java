...
public class BlockPredicatesChecker {
    ...
    public static final PacketCodec<RegistryByteBuf, BlockPredicatesChecker> PACKET_CODEC = PacketCodec.tuple(BlockPredicate.PACKET_CODEC.collect(PacketCodecs.toList()), blockPredicatesChecker -> blockPredicatesChecker.predicates, PacketCodecs.BOOLEAN, BlockPredicatesChecker::showInTooltip, BlockPredicatesChecker::new);
    ...
    private List<Text> getOrCreateTooltipText() {
        if (this.tooltipText == null) {
            this.tooltipText = BlockPredicatesChecker.createTooltipText(this.predicates);
        }
