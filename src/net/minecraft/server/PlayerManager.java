...
public abstract class PlayerManager {
    ...
    public void onPlayerConnect(ClientConnection connection, ServerPlayerEntity player, ConnectedClientData clientData) {
        ...
        ServerRecipeManager lv8 = this.server.getRecipeManager();
        lv6.sendPacket(new SynchronizeRecipesS2CPacket(lv8.getPropertySets(), lv8.getStonecutterRecipeForSync()));
        ...
        if (lv10 != null && !clientData.transferred()) {
    ...
    public ServerPlayerEntity respawnPlayer(ServerPlayerEntity player, boolean alive, Entity.RemovalReason removalReason) {
        ...
        BlockPos lv7 = lv3.getSpawnPointPosition();
        ServerWorld lv8 = this.server.getWorld(lv3.getSpawnPointDimension());
        if (!alive && lv7 != null && lv8 != null && (lv9 = lv8.getBlockState(lv7)).isOf(Blocks.RESPAWN_ANCHOR)) {
