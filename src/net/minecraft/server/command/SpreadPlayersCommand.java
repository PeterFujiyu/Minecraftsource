...
public class SpreadPlayersCommand {
    ...
    private static double getMinDistance(Collection<? extends Entity> entities, ServerWorld world, Pile[] piles, int maxY, boolean respectTeams) {
        ...
        for (Entity entity : entities) {
            ...
            entity.teleport(world, (double)MathHelper.floor(lv3.x) + 0.5, lv3.getY(world, maxY), (double)MathHelper.floor(lv3.z) + 0.5, Set.of(), entity.getYaw(), entity.getPitch(), true);
