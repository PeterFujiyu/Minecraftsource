...
public class ChaseClient {
    ...
    private void executeCommand(String command) {
        this.minecraftServer.execute(() -> {
            ...
            ServerCommandSource lv3 = new ServerCommandSource(lv.getCommandOutput(), Vec3d.of(lv2.getSpawnPos()), Vec2f.ZERO, lv2, 4, "", ScreenTexts.EMPTY, this.minecraftServer, lv);
