...
public class LootTables {
    ...
    public static final Map<DyeColor, RegistryKey<LootTable>> SHEEP_DROPS_FROM_DYE_COLOR = Util.make(new EnumMap(DyeColor.class), lootTableMap -> LootTables.registerAllDyeColors(lootTableMap, "entities/sheep"));
    ...
    public static final Map<DyeColor, RegistryKey<LootTable>> SHEEP_SHEARING_FROM_DYE_COLOR = Util.make(new EnumMap(DyeColor.class), lootTableMap -> LootTables.registerAllDyeColors(lootTableMap, "shearing/sheep"));
    ...
    private static void registerAllDyeColors(EnumMap<DyeColor, RegistryKey<LootTable>> lootTableMap, String lootTableType) {
        for (DyeColor lv : DyeColor.values()) {
            lootTableMap.put(lv, LootTables.register(lootTableType + "/" + lv.getName()));
        }
    }
