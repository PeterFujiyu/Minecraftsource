...
public class LootTableReporter {
    ...
    public void validateContext(LootContextAware contextAware) {
        ...
        Sets.SetView<ContextParameter<?>> set2 = Sets.difference(set, this.contextType.getAllowed());
        if (!set2.isEmpty()) {
            this.errorReporter.report("Parameters " + String.valueOf(set2) + " are not provided in this context");
        }
    }
