...
public class StructureLocator {
    ...
    private Object2IntMap<Structure> collectStructuresAndReferences(NbtCompound nbt) {
        ...
        RegistryWrapper.Impl lv3 = this.registryManager.getOrThrow(RegistryKeys.STRUCTURE);
        for (String string : lv2.getKeys()) {
            String string2;
            NbtCompound lv6;
            Structure lv5;
            Identifier lv4 = Identifier.tryParse(string);
            if (lv4 == null || (lv5 = (Structure)lv3.get(lv4)) == null || (lv6 = lv2.getCompound(string)).isEmpty() || "INVALID".equals(string2 = lv6.getString("id"))) continue;
