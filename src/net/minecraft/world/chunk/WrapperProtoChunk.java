...
extends ProtoChunk {
    ...
    public WrapperProtoChunk(WorldChunk wrapped, boolean propagateToWrapped) {
        super(wrapped.getPos(), UpgradeData.NO_UPGRADE_DATA, wrapped.heightLimitView, (Registry<Biome>)wrapped.getWorld().getRegistryManager().getOrThrow(RegistryKeys.BIOME), wrapped.getBlendingData());
