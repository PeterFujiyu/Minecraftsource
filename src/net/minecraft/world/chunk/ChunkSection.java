...
public class ChunkSection {
    ...
    public ChunkSection(Registry<Biome> biomeRegistry) {
        ...
        this.biomeContainer = new PalettedContainer<RegistryEntry.Reference<Biome>>(biomeRegistry.getIndexedEntries(), biomeRegistry.getOrThrow(BiomeKeys.PLAINS), PalettedContainer.PaletteProvider.BIOME);
    }
