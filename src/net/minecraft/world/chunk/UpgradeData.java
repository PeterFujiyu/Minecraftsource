...
public class UpgradeData {
    ...
    public UpgradeData(NbtCompound nbt, HeightLimitView world) {
        ...
        UpgradeData.addNeighborTicks(nbt, "neighbor_block_ticks", id -> Registries.BLOCK.getOptionalValue(Identifier.tryParse(id)).or(() -> Optional.of(Blocks.AIR)), this.blockTicks);
        UpgradeData.addNeighborTicks(nbt, "neighbor_fluid_ticks", id -> Registries.FLUID.getOptionalValue(Identifier.tryParse(id)).or(() -> Optional.of(Fluids.EMPTY)), this.fluidTicks);
    }
