...
public class BiomeEffects {
    ...
    public static class Builder {
        ...
        public Builder noMusic() {
            return this.music(DataPool.empty()).musicVolume(0.0f);
        }

        public Builder music(DataPool<MusicSound> music) {
