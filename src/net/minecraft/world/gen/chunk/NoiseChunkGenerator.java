...
extends ChunkGenerator {
    ...
    public void buildSurface(ChunkRegion region, StructureAccessor structures, NoiseConfig noiseConfig, Chunk chunk) {
        ...
        this.buildSurface(chunk, lv, noiseConfig, structures, region.getBiomeAccess(), (Registry<Biome>)region.getRegistryManager().getOrThrow(RegistryKeys.BIOME), Blender.getBlender(region));
    }
    ...
    public void carve(ChunkRegion chunkRegion, long seed, NoiseConfig noiseConfig, BiomeAccess biomeAccess, StructureAccessor structureAccessor, Chunk chunk) {
        ...
        CarvingMask lv7 = ((ProtoChunk)chunk).getOrCreateCarvingMask();
        for (int j = -8; j <= 8; ++j) {
            for (int k = -8; k <= 8; ++k) {
                ...
                Iterable<RegistryEntry<ConfiguredCarver<?>>> iterable = lv10.getCarversForStep();
                int m = 0;
    ...
    public void populateEntities(ChunkRegion region) {
        ...
        RegistryEntry<Biome> lv2 = region.getBiome(lv.getStartPos().withY(region.getTopYInclusive()));
