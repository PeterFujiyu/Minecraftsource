...
public class TreeConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, JUNGLE_TREE, Feature.TREE, TreeConfiguredFeatures.jungle().decorators(ImmutableList.of(new CocoaTreeDecorator(0.2f), TrunkVineTreeDecorator.INSTANCE, new LeavesVineTreeDecorator(0.25f))).ignoreVines().build());
