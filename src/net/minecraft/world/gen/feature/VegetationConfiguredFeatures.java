...
public class VegetationConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        RegistryEntry.Reference<PlacedFeature> lv9 = lv7.getOrThrow(TreePlacedFeatures.PALE_OAK_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv10 = lv7.getOrThrow(TreePlacedFeatures.PALE_OAK_CREAKING_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv11 = lv7.getOrThrow(TreePlacedFeatures.BIRCH_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv12 = lv7.getOrThrow(TreePlacedFeatures.FANCY_OAK_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv13 = lv7.getOrThrow(TreePlacedFeatures.BIRCH_BEES_002);
        RegistryEntry.Reference<PlacedFeature> lv14 = lv7.getOrThrow(TreePlacedFeatures.FANCY_OAK_BEES_002);
        RegistryEntry.Reference<PlacedFeature> lv15 = lv7.getOrThrow(TreePlacedFeatures.FANCY_OAK_BEES);
        RegistryEntry.Reference<PlacedFeature> lv16 = lv7.getOrThrow(TreePlacedFeatures.PINE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv17 = lv7.getOrThrow(TreePlacedFeatures.SPRUCE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv18 = lv7.getOrThrow(TreePlacedFeatures.PINE_ON_SNOW);
        RegistryEntry.Reference<PlacedFeature> lv19 = lv7.getOrThrow(TreePlacedFeatures.ACACIA_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv20 = lv7.getOrThrow(TreePlacedFeatures.SUPER_BIRCH_BEES_0002);
        RegistryEntry.Reference<PlacedFeature> lv21 = lv7.getOrThrow(TreePlacedFeatures.BIRCH_BEES_0002);
        RegistryEntry.Reference<PlacedFeature> lv22 = lv7.getOrThrow(TreePlacedFeatures.FANCY_OAK_BEES_0002);
        RegistryEntry.Reference<PlacedFeature> lv23 = lv7.getOrThrow(TreePlacedFeatures.JUNGLE_BUSH);
        RegistryEntry.Reference<PlacedFeature> lv24 = lv7.getOrThrow(TreePlacedFeatures.MEGA_SPRUCE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv25 = lv7.getOrThrow(TreePlacedFeatures.MEGA_PINE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv26 = lv7.getOrThrow(TreePlacedFeatures.MEGA_JUNGLE_TREE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv27 = lv7.getOrThrow(TreePlacedFeatures.TALL_MANGROVE_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv28 = lv7.getOrThrow(TreePlacedFeatures.OAK_CHECKED);
        RegistryEntry.Reference<PlacedFeature> lv29 = lv7.getOrThrow(TreePlacedFeatures.OAK_BEES_002);
        RegistryEntry.Reference<PlacedFeature> lv30 = lv7.getOrThrow(TreePlacedFeatures.SUPER_BIRCH_BEES);
        RegistryEntry.Reference<PlacedFeature> lv31 = lv7.getOrThrow(TreePlacedFeatures.SPRUCE_ON_SNOW);
        RegistryEntry.Reference<PlacedFeature> lv32 = lv7.getOrThrow(TreePlacedFeatures.OAK_BEES_0002);
        RegistryEntry.Reference<PlacedFeature> lv33 = lv7.getOrThrow(TreePlacedFeatures.JUNGLE_TREE);
        RegistryEntry.Reference<PlacedFeature> lv34 = lv7.getOrThrow(TreePlacedFeatures.MANGROVE_CHECKED);
        ...
        DataPool.Builder<BlockState> lv35 = DataPool.builder();
        for (int i = 1; i <= 4; ++i) {
            for (Direction lv36 : Direction.Type.HORIZONTAL) {
                lv35.add((BlockState)((BlockState)Blocks.PINK_PETALS.getDefaultState().with(FlowerbedBlock.FLOWER_AMOUNT, i)).with(FlowerbedBlock.FACING, lv36), 1);
            }
        }
        ConfiguredFeatures.register(featureRegisterable, FLOWER_CHERRY, Feature.FLOWER, new RandomPatchFeatureConfig(96, 6, 2, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(lv35)))));
        ...
        ConfiguredFeatures.register(featureRegisterable, DARK_FOREST_VEGETATION, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(PlacedFeatures.createEntry(lv2, new PlacementModifier[0]), 0.025f), new RandomFeatureEntry(PlacedFeatures.createEntry(lv3, new PlacementModifier[0]), 0.05f), new RandomFeatureEntry(lv8, 0.6666667f), new RandomFeatureEntry(lv11, 0.2f), new RandomFeatureEntry(lv12, 0.1f)), lv28));
        ConfiguredFeatures.register(featureRegisterable, PALE_GARDEN_VEGETATION, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv10, 0.1f), new RandomFeatureEntry(lv9, 0.9f)), lv9));
        ConfiguredFeatures.register(featureRegisterable, PALE_MOSS_VEGETATION, Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(DataPool.builder().add(Blocks.PALE_MOSS_CARPET.getDefaultState(), 25).add(Blocks.SHORT_GRASS.getDefaultState(), 25).add(Blocks.TALL_GRASS.getDefaultState(), 10))));
        ...
        ConfiguredFeatures.register(featureRegisterable, TREES_FLOWER_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv13, 0.2f), new RandomFeatureEntry(lv14, 0.1f)), lv29));
        ConfiguredFeatures.register(featureRegisterable, MEADOW_TREES, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv15, 0.5f)), lv30));
        ConfiguredFeatures.register(featureRegisterable, TREES_TAIGA, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv16, 0.33333334f)), lv17));
        ConfiguredFeatures.register(featureRegisterable, TREES_GROVE, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv18, 0.33333334f)), lv31));
        ConfiguredFeatures.register(featureRegisterable, TREES_SAVANNA, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv19, 0.8f)), lv28));
        ConfiguredFeatures.register(featureRegisterable, BIRCH_TALL, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv20, 0.5f)), lv21));
        ConfiguredFeatures.register(featureRegisterable, TREES_WINDSWEPT_HILLS, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv17, 0.666f), new RandomFeatureEntry(lv12, 0.1f)), lv28));
        ConfiguredFeatures.register(featureRegisterable, TREES_WATER, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv12, 0.1f)), lv28));
        ConfiguredFeatures.register(featureRegisterable, TREES_BIRCH_AND_OAK, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv21, 0.2f), new RandomFeatureEntry(lv22, 0.1f)), lv32));
        ...
        ConfiguredFeatures.register(featureRegisterable, TREES_SPARSE_JUNGLE, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv12, 0.1f), new RandomFeatureEntry(lv23, 0.5f)), lv33));
        ConfiguredFeatures.register(featureRegisterable, TREES_OLD_GROWTH_SPRUCE_TAIGA, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv24, 0.33333334f), new RandomFeatureEntry(lv16, 0.33333334f)), lv17));
        ConfiguredFeatures.register(featureRegisterable, TREES_OLD_GROWTH_PINE_TAIGA, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv24, 0.025641026f), new RandomFeatureEntry(lv25, 0.30769232f), new RandomFeatureEntry(lv16, 0.33333334f)), lv17));
        ConfiguredFeatures.register(featureRegisterable, TREES_JUNGLE, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv12, 0.1f), new RandomFeatureEntry(lv23, 0.5f), new RandomFeatureEntry(lv26, 0.33333334f)), lv33));
        ConfiguredFeatures.register(featureRegisterable, BAMBOO_VEGETATION, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv12, 0.05f), new RandomFeatureEntry(lv23, 0.15f), new RandomFeatureEntry(lv26, 0.7f)), PlacedFeatures.createEntry(lv6, new PlacementModifier[0])));
        ...
        ConfiguredFeatures.register(featureRegisterable, MANGROVE_VEGETATION, Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(lv27, 0.85f)), lv34));
    }
}
