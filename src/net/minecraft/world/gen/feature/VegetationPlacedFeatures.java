...
public class VegetationPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        ...
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv27 = lv.getOrThrow(VegetationConfiguredFeatures.FLOWER_PALE_GARDEN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv28 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_PLAINS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv29 = lv.getOrThrow(VegetationConfiguredFeatures.DARK_FOREST_VEGETATION);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv30 = lv.getOrThrow(VegetationConfiguredFeatures.PALE_GARDEN_VEGETATION);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv31 = lv.getOrThrow(VegetationConfiguredFeatures.FOREST_FLOWERS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv32 = lv.getOrThrow(VegetationConfiguredFeatures.PALE_FOREST_FLOWERS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv33 = lv.getOrThrow(VegetationConfiguredFeatures.PALE_MOSS_PATCH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv34 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_FLOWER_FOREST);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv35 = lv.getOrThrow(VegetationConfiguredFeatures.MEADOW_TREES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv36 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_TAIGA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv37 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_GROVE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv38 = lv.getOrThrow(TreeConfiguredFeatures.OAK);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv39 = lv.getOrThrow(TreeConfiguredFeatures.SPRUCE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv40 = lv.getOrThrow(TreeConfiguredFeatures.CHERRY_BEES_005);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv41 = lv.getOrThrow(TreeConfiguredFeatures.SWAMP_OAK);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv42 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_SAVANNA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv43 = lv.getOrThrow(VegetationConfiguredFeatures.BIRCH_TALL);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv44 = lv.getOrThrow(TreeConfiguredFeatures.BIRCH_BEES_0002);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv45 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_WINDSWEPT_HILLS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv46 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_WATER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv47 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_BIRCH_AND_OAK);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv48 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_SPARSE_JUNGLE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv49 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_OLD_GROWTH_SPRUCE_TAIGA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv50 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_OLD_GROWTH_PINE_TAIGA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv51 = lv.getOrThrow(VegetationConfiguredFeatures.TREES_JUNGLE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv52 = lv.getOrThrow(VegetationConfiguredFeatures.BAMBOO_VEGETATION);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv53 = lv.getOrThrow(VegetationConfiguredFeatures.MUSHROOM_ISLAND_VEGETATION);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lv54 = lv.getOrThrow(VegetationConfiguredFeatures.MANGROVE_VEGETATION);
        ...
        PlacedFeatures.register(featureRegisterable, FLOWER_PALE_GARDEN, lv27, RarityFilterPlacementModifier.of(32), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());
        SurfaceWaterDepthFilterPlacementModifier lv55 = SurfaceWaterDepthFilterPlacementModifier.of(0);
        PlacedFeatures.register(featureRegisterable, TREES_PLAINS, lv28, PlacedFeatures.createCountExtraModifier(0, 0.05f, 1), SquarePlacementModifier.of(), lv55, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BlockFilterPlacementModifier.of(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.getDefaultState(), BlockPos.ORIGIN)), BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, DARK_FOREST_VEGETATION, lv29, CountPlacementModifier.of(16), SquarePlacementModifier.of(), lv55, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, PALE_GARDEN_VEGETATION, lv30, CountPlacementModifier.of(16), SquarePlacementModifier.of(), lv55, PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, FLOWER_FOREST_FLOWERS, lv31, RarityFilterPlacementModifier.of(7), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, CountPlacementModifier.of(ClampedIntProvider.create(UniformIntProvider.create(-1, 3), 0, 3)), BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, FOREST_FLOWERS, lv31, RarityFilterPlacementModifier.of(7), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, CountPlacementModifier.of(ClampedIntProvider.create(UniformIntProvider.create(-3, 1), 0, 1)), BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, PALE_GARDEN_FLOWERS, lv32, RarityFilterPlacementModifier.of(8), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_NO_LEAVES_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, PALE_MOSS_PATCH, lv33, CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_NO_LEAVES_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, TREES_FLOWER_FOREST, lv34, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(6, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_MEADOW, lv35, VegetationPlacedFeatures.treeModifiers(RarityFilterPlacementModifier.of(100)));
        PlacedFeatures.register(featureRegisterable, TREES_CHERRY, lv40, VegetationPlacedFeatures.treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(10, 0.1f, 1), Blocks.CHERRY_SAPLING));
        PlacedFeatures.register(featureRegisterable, TREES_TAIGA, lv36, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_GROVE, lv37, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_BADLANDS, lv38, VegetationPlacedFeatures.treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(5, 0.1f, 1), Blocks.OAK_SAPLING));
        PlacedFeatures.register(featureRegisterable, TREES_SNOWY, lv39, VegetationPlacedFeatures.treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(0, 0.1f, 1), Blocks.SPRUCE_SAPLING));
        PlacedFeatures.register(featureRegisterable, TREES_SWAMP, lv41, PlacedFeatures.createCountExtraModifier(2, 0.1f, 1), SquarePlacementModifier.of(), SurfaceWaterDepthFilterPlacementModifier.of(2), PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of(), BlockFilterPlacementModifier.of(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.getDefaultState(), BlockPos.ORIGIN)));
        PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_SAVANNA, lv42, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(2, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_SAVANNA, lv42, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(1, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, BIRCH_TALL, lv43, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_BIRCH, lv44, VegetationPlacedFeatures.treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(10, 0.1f, 1), Blocks.BIRCH_SAPLING));
        PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_FOREST, lv45, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(3, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_WINDSWEPT_HILLS, lv45, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(0, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_WATER, lv46, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(0, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_BIRCH_AND_OAK, lv47, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_SPARSE_JUNGLE, lv48, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(2, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_OLD_GROWTH_SPRUCE_TAIGA, lv49, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_OLD_GROWTH_PINE_TAIGA, lv50, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(10, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, TREES_JUNGLE, lv51, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(50, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, BAMBOO_VEGETATION, lv52, VegetationPlacedFeatures.treeModifiers(PlacedFeatures.createCountExtraModifier(30, 0.1f, 1)));
        PlacedFeatures.register(featureRegisterable, MUSHROOM_ISLAND_VEGETATION, lv53, SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, TREES_MANGROVE, lv54, CountPlacementModifier.of(25), SquarePlacementModifier.of(), SurfaceWaterDepthFilterPlacementModifier.of(5), PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP, BiomePlacementModifier.of(), BlockFilterPlacementModifier.of(BlockPredicate.wouldSurvive(Blocks.MANGROVE_PROPAGULE.getDefaultState(), BlockPos.ORIGIN)));
    }
}
