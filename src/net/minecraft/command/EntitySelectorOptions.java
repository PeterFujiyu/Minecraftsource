    ...
    public static void register() {
        ...
        EntitySelectorOptions.putOption("nbt", reader -> {
            ...
            reader.addPredicate(entity -> {
                ...
                if (entity instanceof ServerPlayerEntity && !(lv3 = (lv2 = (ServerPlayerEntity)entity).getInventory().getMainHandStack()).isEmpty()) {
                    lv.put("SelectedItem", lv3.toNbt(lv2.getRegistryManager()));
                }
        ...
        EntitySelectorOptions.putOption("predicate", reader -> {
            ...
            reader.addPredicate(entity -> {
                ...
                Optional<LootCondition> optional = lv.getServer().getReloadableRegistries().createRegistryLookup().getOptionalEntry(lv).map(RegistryEntry::value);
                if (optional.isEmpty()) {
                    return false;
                }
                LootWorldContext lv2 = new LootWorldContext.Builder(lv).add(LootContextParameters.THIS_ENTITY, entity).add(LootContextParameters.ORIGIN, entity.getPos()).build(LootContextTypes.SELECTOR);
